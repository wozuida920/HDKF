...
@Controller
@Scope("prototype")
@RequestMapping("csmp/basicData/csmpbdsparepart/CsmpSparepartPageControllerSelect")
public class CsmpSparepartPageControllerSelect implements LoaderConstant {
	private static final Logger logger = LoggerFactory
			.getLogger(CsmpSparepartPageControllerSelect.class);
	...
	public ModelAndView toCsmpBdSparepart(HttpServletRequest request,
		...
		mav.setViewName("avicit/csmp/basicData/csmpbdsparepart/CsmpBdSparepartPagerManageSelect");
		request.setAttribute("url","platform/csmp/basicData/csmpbdsparepart/CsmpSparepartPageControllerSelect/operation/");
		return mav;
	}

	@RequestMapping(value = "/operation/getCsmpBdSparepartSelectByPage")
	@ResponseBody
	public Map<String, Object> togetCsmpBdSparepartByPage(
		...
		if (json != null && !"".equals(json)) {
			...
			param = new CsmpBdSparepartDTO();
		}
		param.setValidFlag("Y");
		queryReqBean.setSearchParams(param);
		try {
			result = service.searchCsmpBdSparepartByPage(queryReqBean,sfnConditions);
