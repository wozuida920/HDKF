package avicit.hdkf.support.hdkfsupporttaskarchive.dto;
...
/**
 * bean HdkfSupportTaskArchive Title: 表HDKF_SUPPORT_TASK_ARCHIVE的PoJo类，也就是数据库映射类
 * Description: HDKF_SUPPORT_TASK_ARCHIVE Copyriht: Copyright (c) 2012 Company:
 * AVICIT Co., Ltd
 * 
 * @author AVICIT DEV
 * @version 1.0 Date: 2016-08-25 15:11
 * 
 */
@PojoRemark(table = "hdkf_support_task_archive", object = "HdkfSupportTaskArchiveDTO", name = "HDKF_SUPPORT_TASK_ARCHIVE")
public class HdkfSupportTaskArchiveDTO extends BeanDTO {
	...
	public String getLogFormName() {
		if (super.logFormName == null || super.logFormName.equals("")) {
			return "HDKF_SUPPORT_TASK_ARCHIVE";
		} else {
