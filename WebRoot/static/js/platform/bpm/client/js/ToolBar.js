...
function doadduserandsubmit(procinstDbid,executionId,taskId,outcome,targetActivityName){
	...
	if(b){
		getFormData();
		var para = "procinstDbid="+procinstDbid+"&executionId="+executionId+"&taskId="+taskId+"&outcome="+outcome+"&targetActivityName="+targetActivityName+"&type=doadduserandsubmit&doSubmitUrl=" + escape("platform/bpm/clientbpmoperateaction/dosupplementassignee") +  "&doSubmitCallEvent=adduserandsubmitBack&random="+Math.random();
