...
ButtonProcessing.ButtonName_AdduserAndSubmit = "doadduserandsubmit"; //增发并提交
ButtonProcessing.ButtonName_Reader = "doglobalreader"; //读者
ButtonProcessing.ButtonName_TaskReader = "dotaskreader"; //读者
...
ButtonProcessing.ButtonPreviousProcessing = function (buttonName,entryId,executionId,currentActivityName,targetActivityName,formId){
	...
	//流程增发并提交
	if(_buttonName == ButtonProcessing.ButtonName_AdduserAndSubmit){
		if(window.beforeAdduserAndSubmit){
			b = beforeAdduserAndSubmit(_entryId,_executionId,_currentActivityName,_targetActivityName,_formId);
		}
	}
	...
	//流程读者
	if(_buttonName == ButtonProcessing.ButtonName_TaskReader){
		if(window.beforeTaskReader){
			b = beforeTaskReader(_entryId,_executionId,_currentActivityName,_targetActivityName,_formId);
		}
	}
	//全局转发
	if(_buttonName == ButtonProcessing.ButtonName_GlobalTransmit){
...
ButtonProcessing.ButtonPostProcessing = function (buttonName,entryId,executionId,currentActivityName,targetActivityName,formId){
	...
	//流程增发并提交
	if(_buttonName == ButtonProcessing.ButtonName_AdduserAndSubmit){
		if(window.afterAdduserAndSubmit){
			b = afterAdduserAndSubmit(_entryId,_executionId,_currentActivityName,_targetActivityName,_formId);
		}
	}
	//流程读者
	if(_buttonName == ButtonProcessing.ButtonName_Reader){
	...
	//流程读者
	if(_buttonName == ButtonProcessing.ButtonName_TaskReader){
		if(window.afterTaskReader){
			b = afterTaskReader(_entryId,_executionId,_currentActivityName,_targetActivityName,_formId);
		}
	}
	//全局转发
	if(_buttonName == ButtonProcessing.ButtonName_GlobalTransmit){
