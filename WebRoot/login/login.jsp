...
<body>
	 <div class="tgbar" id="tgbar">
		<div style="margin:0 0px 0 0">
		  <p style="text-align:center">
		          温馨提示:本平台所涉及的文档密级为内部、公开，其余密级文档请勿上传，谢谢!
		  </p>
		</div>
        <div onclick="document.getElementById('tgbar').style.display='none';" class="closed_btn"><img src="./tgbar_close.gif" /></div>
    </div>
