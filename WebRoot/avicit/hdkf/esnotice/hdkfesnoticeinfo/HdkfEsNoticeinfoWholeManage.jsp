...
<script
	src="avicit/hdkf/esnotice/hdkfesnoticeinfo/js/HdkfEsNoticeinfoWhole.js"
		...
		<table id="dgHdkfEsNoticeinfo"
			...
			<thead>
				<tr>
				    ...
				    <th data-options="field:'countBatchNo', align:'center'" width="120">批架次</th>
					<th data-options="field:'countImplement', align:'center'" width="120">已执行</th>
					...
					<th
						...
						width="220">转发时间</th>
					<th data-options="field:'curStatus', align:'center'" width="220">当前状态</th>
					<th data-options="field:'curProcess', align:'center'" width="220">具体步骤</th>	
