...
<body class="easyui-layout" fit="true">
		...
		<fieldset>
			<form id='form'>
				...
				<table class="form_commonTable">
					...
					<tr>
						<th width="10%"><span class="remind">*</span><label for="bulletinType"> 通报类型 :</label></th>
						...
						<th width="10%"><span class="remind">*</span><label for="materialSupply"> 材料提供方式:</label></th>
					...
					<tr>
						<th width="10%"><span class="remind">*</span><label for="implementCompany"> 实施单位:</label></th>
					...
					<tr>
						...
						<th width="10%"><span class="remind">*</span><label for="includeMars"> 是否包含器材:</label></th>
					...
					<tr>
						...
						<th width="10%"><span class="remind">*</span><label for="attribute13"> 编写日期:</label></th>


						<td width="40%" class="disabled"><input title="编写日期"
							disabled class="easyui-datebox disabled pt6-disabled"
							editable="false" style="width: 182px;" type="text"
							name="attribute13" id="attribute13" required="true"/></td>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			var url = "hdkf/esnotice/hdkfesnoticeinfoeffective/HdkfEsNoticeinfoEffectiveController/HdkfEsNoticeinfoEffectiveInfo1?bulletinId="+bulletinId+"&bulletinNo="+bulletinNo;
