...
<%-- 					 <tr>
					...
					value='${hdkfEsNoticeinfoDTO.completeTime}'/>
 					...
 					<th width="15%"><span class="remind">*</span>转发文号:</th>
					<td width="35%"><input title="转发文号" class="inputbox easyui-validatebox" 
					data-options=" validType:'maxLength[255]'" style="width: 180px;" type="text" 
					name="forwardNo" id="forwardNo" value='<c:out value='${hdkfEsNoticeinfoDTO.forwardNo}'/>'/>
					</td>
					<th width="15%"><span class="remind">*</span>转发时间:</th>
					<td width="35%"><input title="转发时间" class="easyui-datebox" editable="false" 
...
<!-- 	<script src="avicit/hdkf/esnotice/hdkfesnoticeinfo/js/HdkfEsNoticeinfo.js" type="text/javascript"></script>
	...
	function closeForm(){
		parent.hdkfEsNoticeinfo.closeDialog("#trackEditTrackSend");
	}
	...
	//	$('#saveStartButton').linkbutton('disable').unbind("click");
		...
		parent.hdkfEsNoticeinfo.save(serializeObject($('#form')),"#trackEditTrackSend");
	}
