<!-- 作为iframe,作为机型树批架次节点点击后的所涉及的技术通报列表 -->
...
<script
	src="avicit/hdkf/esnotice/hdkfesnoticeinfo/js/HdkfEsNoticeinfoImplement1.js"
...
<%-- 					</sec:accesscontrollist> --%>
<%-- 						<sec:accesscontrollist hasPermission="3" --%>
<%-- 						domainObject="formdialog_hdkfEsNoticeinfo_button_model" --%>
<%-- 				             permissionDes="填写实施结果"> --%>
<!-- 						<td ><a class="easyui-linkbutton" -->
<!-- 							iconCls="icon-edit" plain="true" -->
<!-- 							onclick="hdkfEsNoticeinfo.modify();" href="javascript:void(0);">填写实施结果</a></td> -->
<%-- 					</sec:accesscontrollist> --%>
			...
			<thead>
				<tr>
					<th data-options="field:'id', hidden:true,checkbox:true"
						width="220">主键</th>
					<th
						data-options="field:'bulletinNo', align:'center'"
						width="220">通告编号</th>
				    ...
				    <th data-options="field:'isDone', align:'center',formatter:formatedoFlag" width="120">是否执行</th>
					<th data-options="field:'effectDate', align:'center',formatter:formateDate" width="220">执行时间</th>
					

					<th
						data-options="field:'bulletinType', hidden:true,formatter:formatebulletinType"
						width="220">通报类型</th>
					<th
					...
					<th
						...
						width="160">实施单位</th>
					<th
						data-options="field:'includeMars', hidden:true,formatter:formateincludeMars"
						width="150">包含器材</th>
					<th
					...
					<th
						data-options="field:'completeTime', align:'center',formatter:formateDate"
						width="220">应完成时间</th>
	...
	<div id="searchDialog"
		...
		<form id="hdkfEsNoticeinfo">
			<table class="form_commonTable">
				...
				<tr>
					<th width="10%">编写日期从:</th>
					<td width="40%"><input name="attribute13Begin"
						id="attribute13Begin" class="easyui-datebox" editable="false" />
					<th width="10%">编写日期(至):</th>
					<td><input name="attribute13End" id="attribute13End"
						class="easyui-datebox" editable="false" /></td>
				</tr>
				<tr>
					<th width="10%">完成日期从:</th>
					<td width="40%"><input name="completeTimeBegin"
						id="completeTimeBegin" class="easyui-datebox" editable="false" />
					<th width="10%">编写日期(至):</th>
					<td><input name="completeTimeEnd" id="completeTimeEnd"
						class="easyui-datebox" editable="false" /></td>
				</tr>
