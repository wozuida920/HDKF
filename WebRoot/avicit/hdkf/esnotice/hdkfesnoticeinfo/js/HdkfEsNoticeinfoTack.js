...
HdkfEsNoticeinfo.prototype.init=function(){
	...
	this._datagrid=$(this._datagridId).datagrid({
		url:this.getUrl()+"getHdkfEsNoticeinfosTrackByPage.json",//getHdkfEsNoticeinfosByPage
...
//上报详情页面
//详细页
HdkfEsNoticeinfo.prototype.detailtrack=function(id, flowstate){
	//if(flowstate != null && flowstate != "null" &&flowstate != ""){
		var url ="avicit/hdkf/esnotice/hdkfesnoticeinfo/HdkfEsNoticeinfoDetailTrack.jsp?id=" + id;
...
/*				 if(typeof(callback)=="function"){
				 ...
				 if(callback=="#trackEditTrackSend" ||callback=="#trackEditTrackReport" ||callback=="#trackEditTrackAnswer" ){
