...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			<input type="hidden" name="version"
				value='${hdkfEsNoticeinfoDTO.version}' /> <input type="hidden"
				name="id" value='${hdkfEsNoticeinfoDTO.id}' />
			<table class="form_commonTable">
				<tr>
					...
					<td width="40%"><input title="通告编号"
						...
						value='<c:out value='${hdkfEsNoticeinfoDTO.bulletinNo}'/>' /></td>
					<th width="10%">标题:</th>
					<td width="40%"><input title="标题"
						class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[255]'" style="width: 180px;"
						type="text" name="title" id="title"
						value='<c:out value='${hdkfEsNoticeinfoDTO.title}'/>' /></td>
				</tr>
				<tr>
					...
					<td width="40%"><input title="机关联系人"
						class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[255]'" style="width: 180px;"
						type="text" name="organContact" id="organContact"
						value='<c:out value='${hdkfEsNoticeinfoDTO.organContact}'/>' /></td>
					...
					<td width="40%"><input title="机关联系人电话"
						...
						value='<c:out value='${hdkfEsNoticeinfoDTO.telephone}'/>' /></td>
				</tr>
				<tr>
					<th width="10%">通报类型 :</th>
					<td width="40%"><pt6:syslookup name="bulletinType"
							isNull="true" lookupCode="CSMP_ES_INFO_TYPE"
							defaultValue='${hdkfEsNoticeinfoDTO.bulletinType}'
					...
					<td width="40%"><pt6:syslookup name="materialSupply"
							...
							defaultValue='${hdkfEsNoticeinfoDTO.materialSupply}'
							dataOptions="width:180,editable:false,panelHeight:'auto'">
						</pt6:syslookup></td>
				</tr>
				<tr>
					...
					<td width="40%"><pt6:syslookup name="implementCompany"
							...
							defaultValue='${hdkfEsNoticeinfoDTO.implementCompany}'
							dataOptions="width:180,editable:false,panelHeight:'auto'">
						</pt6:syslookup></td>
					<th width="10%">预计上报日期:</th>
					<td width="40%"><input title="预计上报日期" class="easyui-datebox"
						editable="false" style="width: 182px;" type="text"
						name="reportDate" id="reportDate"
						value='${hdkfEsNoticeinfoDTO.reportDate}' /></td>
				</tr>
				<tr>
					<th width="10%">编者:</th>
					<td width="40%"><input title="编者"
						...
						value='<c:out value='${hdkfEsNoticeinfoDTO.author}'/>' /></td>
					<th width="10%">编发单位:</th>
					<td width="40%"><input title="编发单位"
						class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[255]'" style="width: 180px;"
						type="text" name="fileCompany" id="fileCompany"
						value='<c:out value='${hdkfEsNoticeinfoDTO.fileCompany}'/>' /></td>
				</tr>
				<tr>
					<th width="10%">电话:</th>
					<td width="40%"><input title="电话"
						class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[50]'" style="width: 180px;"
						type="text" name="companyTel" id="companyTel"
						value='<c:out value='${hdkfEsNoticeinfoDTO.companyTel}'/>' /></td>
					<th width="10%">是否包含器材:</th>
					<td width="40%"><pt6:syslookup name="includeMars"
							isNull="true" lookupCode="PLATFORM_YES_NO_FLAG"
							defaultValue='${hdkfEsNoticeinfoDTO.includeMars}'
							dataOptions="width:180,editable:false,panelHeight:'auto'">
						</pt6:syslookup></td>
				</tr>
				<tr>
					<th width="10%">预计发布日期:</th>
					<td width="40%"><input title="预计发布日期" class="easyui-datebox"
						editable="false" style="width: 182px;" type="text"
						name="publishDate" id="publishDate"
						value='${hdkfEsNoticeinfoDTO.publishDate}' /></td>
					<th width="10%">预计应完成日期:</th>
					<td width="40%"><input title="预计应完成日期" class="easyui-datebox"
						editable="false" style="width: 182px;" type="text"
						name="completeDate" id="completeDate"
						value='${hdkfEsNoticeinfoDTO.completeDate}' /></td>
				</tr>
				<tr>
					<th width="10%">更改单号:</th>
					<td width="40%"><input title="更改单号"
						class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[255]'" style="width: 180px;"
						type="text" name="changeNo" id="changeNo"
						value='<c:out value='${hdkfEsNoticeinfoDTO.changeNo}'/>' /></td>
					<th width="10%">执行要求:</th>
					<td width="40%"><input title="执行要求"
						class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[1024]'" style="width: 180px;"
						type="text" name="performRequirement" id="performRequirement"
						value='<c:out value='${hdkfEsNoticeinfoDTO.performRequirement}'/>' />
					</td>
				</tr>
				<tr>
					<th width="10%">换版内容:</th>
					<td width="40%"><input title="换版内容"
						class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[1024]'" style="width: 180px;"
						type="text" name="changeComment" id="changeComment"
						value='<c:out value='${hdkfEsNoticeinfoDTO.changeComment}'/>' /></td>
					<th width="10%">备注:</th>
					<td width="40%"><input title="备注"
						class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[1024]'" style="width: 180px;"
						type="text" name="remark" id="remark"
						value='<c:out value='${hdkfEsNoticeinfoDTO.remark}'/>' /></td>
				</tr>
				<tr>
					<th width="10%">上报文号:</th>
					<td width="40%"><input title="上报文号"
						class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[255]'" style="width: 180px;"
						type="text" name="reportNo" id="reportNo"
						value='<c:out value='${hdkfEsNoticeinfoDTO.reportNo}'/>' /></td>
					<th width="10%">上报时间:</th>
					<td width="40%"><input title="上报时间" class="easyui-datebox"
						editable="false" style="width: 182px;" type="text"
						name="reportTime" id="reportTime"
						value='${hdkfEsNoticeinfoDTO.reportTime}' /></td>
				</tr>
				<tr>
					<th width="10%">批复文号:</th>
					<td width="40%"><input title="批复文号"
						class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[255]'" style="width: 180px;"
						type="text" name="replyNo" id="replyNo"
						value='<c:out value='${hdkfEsNoticeinfoDTO.replyNo}'/>' /></td>
					<th width="10%">批复时间:</th>
					<td width="40%"><input title="批复时间" class="easyui-datebox"
						editable="false" style="width: 182px;" type="text"
						name="replyTime" id="replyTime"
						value='${hdkfEsNoticeinfoDTO.replyTime}' /></td>
				</tr>
				<tr>
					<th width="10%">应完成时间:</th>
					<td width="40%"><input title="应完成时间" class="easyui-datebox"
						editable="false" style="width: 182px;" type="text"
						name="completeTime" id="completeTime"
						value='${hdkfEsNoticeinfoDTO.completeTime}' /></td>
					<th width="10%">转发文号:</th>
					<td width="40%"><input title="转发文号"
						class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[255]'" style="width: 180px;"
						type="text" name="forwardNo" id="forwardNo"
						value='<c:out value='${hdkfEsNoticeinfoDTO.forwardNo}'/>' /></td>
				</tr>
				<tr>
					<th width="10%">转发时间:</th>
					<td width="40%"><input title="转发时间" class="easyui-datebox"
						editable="false" style="width: 182px;" type="text"
						name="forwardTime" id="forwardTime"
						value='${hdkfEsNoticeinfoDTO.forwardTime}' /></td>
				</tr>
			</table>
		</form>
		<jsp:include
	...
	function closeForm(){
		parent.hdkfEsNoticeinfo.closeDialog("#edit");
	}
