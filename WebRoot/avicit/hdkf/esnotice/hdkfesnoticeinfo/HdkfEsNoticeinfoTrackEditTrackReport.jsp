...
<%-- 					<tr>
					...
					value='<c:out value='${hdkfEsNoticeinfoDTO.remark}'/>'/>
 					...
 					<tr>
					<th width="15%"><span class="remind">*</span>上报文号:</th>
					<td width="35%"><input title="上报文号" class="inputbox easyui-validatebox" 
					data-options="validType:'maxLength[255]'" style="width: 180px;" type="text" 
					name="reportNo" id="reportNo" value='<c:out value='${hdkfEsNoticeinfoDTO.reportNo}'/>'/>
					</td>
					<th width="15%"><span class="remind">*</span>上报时间:</th>
					<td width="35%"><input title="上报时间" class="easyui-datebox" editable="false" style="width: 182px;" 
					type="text" name="reportTime" id="reportTime" required="true"
					value='${hdkfEsNoticeinfoDTO.reportTime}'/>
					</td>
					</tr>
					
<%-- 					<th width="10%">批复文号:</th>
					<td width="40%"><input title="批复文号" class="inputbox easyui-validatebox" 
					data-options="validType:'maxLength[255]'" style="width: 180px;" type="text" 
					name="replyNo" id="replyNo" value='<c:out value='${hdkfEsNoticeinfoDTO.replyNo}'/>'/>
					</td>
					<th width="10%">批复时间:</th>
					<td width="40%"><input title="批复时间" class="easyui-datebox"  editable="false" 
					style="width: 182px;" type="text" name="replyTime" id="replyTime" 
					value='${hdkfEsNoticeinfoDTO.replyTime}'/>
					</td>
					</tr>
					<tr>
					<th width="10%">应完成时间:</th>
					<td width="40%"><input title="应完成时间" class="easyui-datebox"  editable="false" 
					style="width: 182px;" type="text" name="completeTime" id="completeTime" 
					value='${hdkfEsNoticeinfoDTO.completeTime}'/>
					</td> --%>
<%--  					<th width="10%">转发文号:</th>
...
<%-- 		<jsp:include page="/avicit/platform6/modules/system/swfupload/swfEditInclude.jsp">
	...
	function closeForm(){
		parent.hdkfEsNoticeinfo.closeDialog("#trackEditTrackReport");
	}
	...
	//	$('#saveButton').linkbutton('disable').unbind("click");
		...
		parent.hdkfEsNoticeinfo.save(serializeObject($('#form')),"#trackEditTrackReport");
	}
