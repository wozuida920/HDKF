...
<script type="text/javascript">
		...
		$(function(){
			hdkfEsReportTrack= new HdkfEsReportTrack('dgHdkfEsReportTrack','${url}','searchDialog','hdkfEsReportTrack');
																																																																																																																																																																																																																																																																																																																																															/////
			var array=[];
		...
		<div id="toolbarHdkfEsReportTrack" class="datagrid-toolbar">
			<table>
				<tr>
					...
					<sec:accesscontrollist hasPermission="3"
						domainObject="formdialog_hdkfEsReportTrack_button_query"
						permissionDes="查询">
						<td><a class="easyui-linkbutton" iconCls="icon-search"
							plain="true" onclick="hdkfEsReportTrack.openSearchForm();"
							href="javascript:void(0);">查询</a></td>
					</sec:accesscontrollist>
					<sec:accesscontrollist hasPermission="3"
						domainObject="formdialog_hdkfEsReportTrack_button_seniorquery"
						permissionDes="高级查询">
						<td><a class="easyui-linkbutton" iconCls="icon-search"
	...
	<div id="searchDialog"
		...
		<form id="hdkfEsReportTrack">
			<table class="form_commonTable">
				<tr>
					<th width="10%">技术通报编号:</th>
					<td width="40%"><input class="easyui-validatebox"
						style="width: 151px;" type="text" name="techinalBulletinId" /></td>
					<th width="10%">通告编号:</th>
					<td width="40%"><input class="easyui-validatebox"
				...
				<th width="10%">备注:</th>
				<td width="40%"><input class="easyui-validatebox"
					style="width: 151px;" type="text" name="remark" /></td>
				</tr>
				<tr>
				</tr>
			</table>
			...
			<table class="tableForm" border="0" cellspacing="1" width='100%'>
				<tr>
					<td align="right"><a class="easyui-linkbutton primary-btn"
						iconCls="" plain="false" onclick="hdkfEsReportTrack.searchData();"
						href="javascript:void(0);">查询</a> <a class="easyui-linkbutton"
						iconCls="" plain="false" onclick="hdkfEsReportTrack.clearData();"
						href="javascript:void(0);">清空</a> <a class="easyui-linkbutton"
						iconCls="" plain="false"
						onclick="hdkfEsReportTrack.hideSearchForm();"
