		...
		<table id="dgCsmpEsNoticeinfoEffective"
								...
								<thead>
									<tr>
										...
										<th data-options="field:'companyName',align:'center', halign:'center'" width="220">名称</th>
										<th data-options="field:'shortName',align:'center', halign:'center'" width="220">简称</th>
										<th data-options="field:'nameEn',align:'center', halign:'center'" width="220">英文名</th>
										<th data-options="field:'address',align:'center', halign:'center'" width="220">地址</th>
									</tr>
								</thead>
		</table>
...
<!-- 	</div> -->
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.csmpEsNoticeinfoEffective.closeDialog("#countName");
		}
	</script>
</body>
</html>