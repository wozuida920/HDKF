...
<script type="text/javascript">
	...
	window.beforeSubmit = function( _entryId,_executionId,_currentActivityName,_targetActivityName,_formId){
	  ...
	  return true;
	 		...
	 		//打开批架次页面
	function openDialog() {
		var co1=$("#requestUnit").val();
		var modelid=$("#modelId").val();
		var co=co1+","+modelid;
		this.nData = new CommonDialog("model", "790", "500", "hdkf/support/hdkfsupportrequestinfo/HdkfSupportRequestInfoController/HdkfBdAircraftinfoInfos/"+co, "批架次选择", false, true, false);
		this.nData.show();
	} 
	
	function callBackData(data,batchNos) {
		$("#model").dialog("close");
        var requestUnit=$("#requestUnit").val();	
		 var idR = formId;
		// alert(requestUnit+"****"+idR);
	...
	$(function() {
		...
		var  requestUnitVal=$("#requestUnit").val();
		var  modelIdVal=$("#modelId").val();
		var url1 = "hdkf/support/hdkfsupportfaultdetail/HdkfSupportFaultDetailController/HdkfSupportFaultDetailInfoModel?requestId="+formId+"&requestUnit="+requestUnitVal+"&modelId="+modelIdVal;
		$("#iframeId").css('display','block');
		$("#iframeId").attr("src",url1);
...
/* 		var idR =formId;
		...
		var modelid=$("#modelId").val();
		alert(requestUnitR+"++++"+modelid);
		var url = "hdkf/support/hdkfsupportfaultdetail/HdkfSupportFaultDetailController/HdkfSupportFaultDetailInfoModel?requestId="+idR+"&requestUnit="+requestUnitR+"&modelId="+modelid;
		$("#iframeId").css('display','block');
		$("#iframeId").attr("src",url); */
