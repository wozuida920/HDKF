...
<script type="text/javascript">
	...
	$(function() {
		...
		var idR = formId;
		var url = "hdkf/support/hdkfsupportfaultdetail/HdkfSupportFaultDetailController/HdkfSupportFaultDetailInfo2?requestId="
				+ idR;
		...
		<fieldset>
			...
			<form id='formDetail'>
				...
				<table class="form_commonTable">
					...
					<th align="right"><label>机型</label></th>
						<td>
						<input title="批架次" class="easyui-validatebox"
						style="width: 180px;" type="hidden" name="batchNo"
						id="batchNo" disabled />
...
<!-- 					</tr> -->
					<tr>
						...
						<td width="117px" colspan="5" style="padding-left: 3px"><input
							title="信息卡标题" class="easyui-validatebox"
...
<!-- 					</tr> -->
					...
					<tr>
						...
						<td><input title="技术员姓名" class="easyui-validatebox"
							style="width: 180px;" type="text" name="requestManagerName"
							id="requestManagerName" disabled /> <input title="技术员ID"
							class="easyui-validatebox" type="hidden" name="requestManagerId"
							id="requestManagerId" disabled /></td>

						<th align="right"><label>发外场信息卡</label></th>
					...
					<tr>
						...
						<td><pt6:syslookup name="infoType"
								...
								dataOptions="required:true,width:180,editable:false,disabled:true,panelHeight:'auto'"></pt6:syslookup></td>
						<th align="right"><label>发公用笺</label></th>
