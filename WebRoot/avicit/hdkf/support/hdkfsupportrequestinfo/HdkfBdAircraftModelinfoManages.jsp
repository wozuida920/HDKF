...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center'" style="background: #ffffff; height: auto; padding: 0px; overflow: hidden;">
		<div class="easyui-layout" fit="true">
			<div data-options="region:'north',title:' '" style="height: 118px;">
				<form id="csmpBdAircraftinfo">
					<table class="form_commonTable">
					  <tr>
					      <th width="35%">机型:</th>
							<td width="65%"><input class="easyui-validatebox" 
...
<%-- 							<sec:accesscontrollist hasPermission="3"
	...
	<script
		src="avicit/hdkf/support/hdkfsupportrequestinfo/js/HdkfBdAircraftinfoModels.js"
		type="text/javascript"></script>
