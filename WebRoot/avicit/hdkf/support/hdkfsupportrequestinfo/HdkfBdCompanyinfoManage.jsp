...
<body class="easyui-layout" fit="true">
	...
	<div data-options="region:'center'"
		...
		<div class="easyui-layout" data-options="fit:true">
			...
			<!--第二张表  -->
			<div data-options="region:'center'"
				style="height: 250px; background: #fafafa;font-size:0;">
						...
						<tr>
							<sec:accesscontrollist hasPermission="3"
								...
								<td><a class="easyui-linkbutton" iconCls="icon-add"
									plain="true" onclick="csmpBdCompanyinfo.setConpanyAlias();" href="javascript:void(0);">确认</a></td>
				...
				striped:true">
					<thead>
						<tr>
							<th data-options="field:'nodeId',hidden:true,align:'center',checkbox:true"
								width="220">结构ID:</th>
							<th data-options="field:'companyCode', align:'center'"
								width="220">单位编码</th>
							<th
								data-options="field:'companyName', align:'center'"
								width="220">名称</th>
							...
							<th
								data-options="field:'country', align:'center',formatter:formatecountry"
								width="220">国家</th>
							<th
	...
	<script
		src="avicit/hdkf/support/hdkfsupportrequestinfo/js/HdkfBdCompanyinfo.js"
		type="text/javascript"></script>
	<script
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			csmpBdCompanystructure.setOnSelect(function(_tree, node) {
				...
				csmpBdCompanyinfo.setOnClick(function(rowdata){
					 parent.callBackDataConpany(rowdata);
				});
			});
