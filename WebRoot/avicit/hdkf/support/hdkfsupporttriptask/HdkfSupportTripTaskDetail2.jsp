	...
	window.beforeSubmit = function( _entryId,_executionId,_currentActivityName,_targetActivityName,_formId){
		...
		.ajax({
			...
			success : function(result) {
				if (result.flag == "success") {
					//进行时间转化
					noticeTime = result.hdkfSupportTripTask.noticeTime;
...
<!-- 					</tr> -->
					<tr>
					<th align="right"><span class="remind">*</span>通知客户时间</th>
						<td><input title="通知客户时间" class="easyui-datebox"
							style="width: 180px;" type="text" name="noticeTime"  required="true" 
							id="noticeTime" disabled /></td>
						<th align="right"><span class="remind">*</span>赴外场出发时间</th>
						<td><input title="赴外场出发时间" class="easyui-datebox"
							style="width: 180px;" type="text" name="tripStartTime"  required="true" 
