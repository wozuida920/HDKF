			...
			<table class="tableForm" border="0" cellspacing="0" width='100%'>
				<tr>
					<td align="center"><a class="easyui-linkbutton " iconCls=""
						plain="false" onclick="hdkfSupportDealByKf.searchData();"
						href="javascript:void(0);">查询</a> <a class="easyui-linkbutton"
						iconCls="" plain="false" onclick="hdkfSupportDealByKf.clearData();"
...
<!-- 				</tr> -->
<!-- 				<tr> -->
<!-- 					<th width="10%">外场信息处理卡ID:</th> -->
<!-- 					<td width="40%"><input class="easyui-validatebox" -->
<!-- 						style="width: 151px;" type="text" name="outfieldCardId" /></td> -->
<!-- 					<th width="10%">外场信息处理卡编号:</th> -->
<!-- 					<td width="40%"><input class="easyui-validatebox" -->
<!-- 						style="width: 151px;" type="text" name="outfieldCardNo" /></td> -->
<!-- 				</tr> -->
<!-- 				<tr> -->
<!-- 					<th width="10%">处理处室:</th> -->
...
<!-- 	</div> -->
	...
	<script
		src=" avicit/hdkf/support/hdkfsupporttriptask/js/HdkfSupportDealByKf.js"
		type="text/javascript"></script>
	<script type="text/javascript">
		...
		$(function() {
			...
			hdkfSupportDealByKf.setOnClick(function(rowdata){
				 parent.setDealByKfData(rowdata);
			});
