...
<!-- 						href="javascript:void(0);">高级查询</a></td> -->
			...
			<thead>
				<tr>
					...
					<th
						...
						width="220">请求处理ID</th>
					<th data-options="field:'taskNo', align:'center', formatter:formateHref" width="220">任务书编号</th>
					<th data-options="field:'taskName', align:'center'" width="220">任务书名称</th>
					<th
						data-options="field:'isNeedEquipment', align:'center',formatter:formateisNeedEquipment"
						width="220">是否需要器材</th>
					<th data-options="field:'needEquipment', hidden:true"
						width="220">需要的器材</th>
					<th
						data-options="field:'isBorrowSomeone', align:'center',formatter:formateisBorrowSomeone"
						width="220">是否借人</th>
					<th data-options="field:'writeManId', hidden:true" width="220">填写人ID</th>
					<th data-options="field:'writeManName', align:'center'"
						width="220">填写人姓名</th>
					<th data-options="field:'contentDemand', hidden:true"
						width="220">任务内容与要求</th>
					<th data-options="field:'feeNo', hidden:'true'" width="220">费用编号</th>
					<th data-options="field:'toArmyName', align:'center'" width="220">排故所去部队</th>
					<th data-options="field:'executors', align:'center'" width="220">执行者</th>
					<th data-options="field:'totalHours', align:'center'" width="220">总任务完成时间（天）</th>
					<th
	...
	<script
		src=" avicit/hdkf/support/hdkfsupporttriptask/js/HdkfSupportTripTask.js"
		type="text/javascript"></script>
