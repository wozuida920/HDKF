...
<script type="text/javascript">
	...
	window.beforeSubmit = function( _entryId,_executionId,_currentActivityName,_targetActivityName,_formId){
		...
		if ($("#taskDetails").val().length>2000) {
			alert("执行者任务完成详细说明的长度不能超过2000！");
			return false;
		}
		if ($("#suggestionDemand").val().length>2000) {
			alert("部队领导意见及要求的长度不能超过2000！");
			return false;
		}
			return true;
	};
	...
	$(function() {
		...
		//	var taskId =formId;
			...
			//alert(taskNo);
			var url = "hdkf/support/hdkfsupportdevicedetail/HdkfSupportDeviceDetailController/HdkfSupportDeviceDetailInfo2?taskId="+formId+"&taskNo="+taskNo;
...
<!-- 						<th align="right"><span class="remind">*</span>执行者</th> -->
...
<!-- 							disabled /></td> -->
					...
					<tr>
						...
						<th align="right"><span class="remind">*</span>任务实际开始时间</th>
						<td><input title="任务实际开始时间" class="easyui-datebox"
							style="width: 180px;" type="text" name="startDate" id="startDate"  required="true" 
							disabled /></td>
						<th align="right"><span class="remind">*</span>任务实际完成时间</th>
						<td><input title="任务实际完成时间" class="easyui-datebox"
							style="width: 180px;" type="text" name="endDate" id="endDate"  required="true" 
							disabled /></td>
					</tr>
					<tr>
						<th align="right"><span class="remind">*</span>总任务完成天数</th>
						<td><input title="总任务完成天数" class="easyui-numberbox"  required="true" 
							style="width: 180px;" type="text" name="totalHours"
							id="totalHours" disabled /></td>
<!-- 						<th align="right"><span class="remind">*</span>任务完成详细说明</th> -->
...
<!-- 							id="taskDetails" disabled /></td> -->
					...
					<tr>
				     <th align="right"><span class="remind">*</span>执行者:</th>
					<td   colspan="5"  style="padding-left: 3px"><input title="执行者"
						class="inputbox easyui-validatebox"
						data-options="required:true,validType:'maxLength[300]'" style="width: 180px;"
						type="text" name="executors" id="executors"  required="true" disabled/></td>
...
<!-- 					</tr> -->
				...
				<td  colspan="5" align="left" style="padding-left: 3px">
					<textarea rows="12"
						...
						class="textareabox" name="taskDetails" id="taskDetails"  
						style="resize:none" disabled></textarea></td>
				</tr>			
				<tr>
				<th align="right"><span class="remind">*</span>部队领导意见及要求</th>
...
<!-- 					<th align="right"><span class="remind">*</span>任务评价</th> -->
<!-- 					<td  colspan="5" align="left" style="padding-left: 3px"> -->
<!-- 					<textarea rows="12" -->
<!-- 						data-options="required:true,validType:'maxLength[4000]'"  -->
