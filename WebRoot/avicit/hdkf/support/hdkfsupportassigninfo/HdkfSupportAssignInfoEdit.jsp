			...
			<table class="form_commonTable">
				<tr>
					...
					<td width="40%"><input title="委托人ID"
						...
						type="text" name="assignUserId" id="assignUserId"
						value='<c:out value='${hdkfSupportAssignInfoDTO.assignUserId}'/>' />
					</td>
					<th width="10%">委托人:</th>
					<td width="40%"><input title="委托人"
						...
						value='<c:out value='${hdkfSupportAssignInfoDTO.assignUserName}'/>' />
					</td>
				</tr>
				<tr>
					...
					<td width="40%"><input title="受托人ID"
						class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[100]'" style="width: 180px;"
						type="text" name="assignedUserId" id="assignedUserId"
						value='<c:out value='${hdkfSupportAssignInfoDTO.assignedUserId}'/>' />
					</td>
					<th width="10%">受托人:</th>
					<td width="40%"><input title="受托人"
						...
						value='<c:out value='${hdkfSupportAssignInfoDTO.assignedUserName}'/>' />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="40%"><input title="委托理由"
						...
						type="text" name="assignReason" id="assignReason"
						value='<c:out value='${hdkfSupportAssignInfoDTO.assignReason}'/>' />
					</td>
					<th width="10%">是否中止委托:</th>
					<td width="40%"><pt6:syslookup name="suspendFlag"
							lookupCode="SUPPORT_ASSIGN_STATUS" isNull="true"
				...
				<tr>
					...
					<td width="40%"><input title="中止委托理由"
						class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[4000]'" style="width: 180px;"
						type="text" name="suspendReason" id="suspendReason"
						value='<c:out value='${hdkfSupportAssignInfoDTO.suspendReason}'/>' />
					</td>
