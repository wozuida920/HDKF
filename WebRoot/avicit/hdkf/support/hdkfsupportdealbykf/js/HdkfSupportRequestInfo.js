 ...
 * 
 */
 function HdkfSupportRequestInfo(datagrid,url,searchD,form){
...
HdkfSupportRequestInfo.prototype.init=function(){
	...
	this._datagrid=$(this._datagridId).datagrid({
		url:this.getUrl()+"getHdkfSupportRequestInfosByPage.json",
...
//添加页面
HdkfSupportRequestInfo.prototype.insert=function(){
	this.nData = new CommonDialog("insert","990","1500",this.getUrl()+'Add/null',"添加",false,true,false);
	                             //  id,width,height,content,title,closable,modal,useDefaultButton,appendIframe,isMaximized,maximizable
	this.nData.show();
};
//修改页面
HdkfSupportRequestInfo.prototype.modify=function(){
...
//详细页
HdkfSupportRequestInfo.prototype.detail=function(id, value){
//	this.nData = new CommonDialog("edit","790","500",this.getUrl()+'Detail/'+id,"详情",false,true,false);
//	this.nData.show();
//	var url = this.getUrl()+'Detail/'+id;
	var url = "avicit/hdkf/support/hdkfsupportrequestinfo/HdkfSupportRequestInfoDetail.jsp?id=" + id;
...
//保存并启动流程
HdkfSupportRequestInfo.prototype.saveFormAndStartFlow=function(form,id){
	var _self = this;
...
//保存功能
HdkfSupportRequestInfo.prototype.save=function(form,id){
	var _self = this;
	$.ajax({
...
//删除
HdkfSupportRequestInfo.prototype.del=function(){
	var rows = this._datagrid.datagrid('getChecked');
	var _self = this;
	var ids = [];
	var l =rows.length;
...
//重载数据
HdkfSupportRequestInfo.prototype.reLoad=function(){
	//this._datagrid.datagrid('load',{});
		this.searchData();
};
//关闭对话框
HdkfSupportRequestInfo.prototype.closeDialog=function(id){
	$(id).dialog('close');
};

//打开查询框
HdkfSupportRequestInfo.prototype.openSearchForm =function(){
...
//隐藏查询框
HdkfSupportRequestInfo.prototype.hideSearchForm =function(){
	this.searchDialog.dialog('close',true);
};
/*清空查询条件*/
...
HdkfSupportRequestInfo.prototype.initWorkFlow=function(status, owner){
