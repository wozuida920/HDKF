...
// 		}
	...
	$(function() {
		...
		if(attribute03=='Y'){
			...
			//alert("infoCardNo-->"+infoCardNo);
			//alert(taskNo);
			var url = "hdkf/support/hdkfsupportsolutiondetail/HdkfSupportSolutionDetailController/HdkfSupportSolutionDetailInfo?infoCardNo="+infoCardNo;
...
<!-- 					</tr> -->
					...
					<tr >
						...
						<td id="doneTime_td"><input title="方案形成时间" class="easyui-datebox"
