...
<script type="text/javascript">
	...
	$(function() {
		...
		var dealUserIdCommonSelector = new CommonSelector("user",
				"uerSelectCommonDialog", "dealUserId", "dealUserName", null,
				null, null, false);
	...
	window.beforeSubmit = function(_entryId, _executionId,
		...
		var attribute03 = $("#attribute03").combobox('getValue');
		if (attribute03 != 'Y') {
			if ($("#dealSolution").val() == "") {
	...
	$(function() {
		...
		var attribute03 = $("#attribute03").combobox('getValue');
		//alert("here--->" + attribute03);
		if (attribute03 == 'Y') {
			//alert("in--->"+isNeedEquipment);

			//var taskId =formId;
			//alert(taskId);
			var infoCardNo = $("#infoCardNo").val();
			//alert("taskNo-->"+taskNo);
			//alert(taskNo);
			var url = "hdkf/support/hdkfsupportsolutiondetail/HdkfSupportSolutionDetailController/HdkfSupportSolutionDetailInfo1?infoCardNo="
					+ infoCardNo;

			//alert(validFlag);
			$("#iframeIdR").css('display', 'block');
			$("#doneTime_th").css('display', 'none');
			$("#doneTime_td").css('display', 'none');
			$("#dealSolution_th").css('display', 'none');
			$("#dealSolution_td").css('display', 'none');
			$("#dealUser_th").css('display','none');
			$("#dealUser_td").css('display','none');
			$("#iframeIdR").attr("src", url);

		} else if (attribute03 == 'N') {
			$("#iframeIdR").css('display', 'none');
		}
	});
...
<body class="easyui-layout" fit="true">
	<div region='center' border="false" style="overflow: true;">
		...
		<fieldset>
			...
			<form id='formDetail'>
				...
				<table class="form_commonTable">
					...
					<tr>
						<th align="right" id="doneTime_th"><span class="remind">*</span><label>方案形成时间</label></th>
						<td id="doneTime_td"><input title="方案形成时间"
							class="easyui-datebox" editable="false" style="width: 180px;"
							type="text" name="doneTime" id="doneTime" required="true"
							disabled /></td>
					...
					<tr>
						...
						<th align="right" id="dealUser_th"><label>承办单位处理人</label></th>
						<td id="dealUser_td">
							<!-- 修改于0926，将选择人框修改成为输入框 --> <input title="承办单位处理人"
							class="easyui-validatebox" style="width: 180px; display: none;"
							type="text" name="dealUserId" id="dealUserId" disabled /> <input
					...
					<!-- 					<tr> -->
					<!-- 							<th align="right"><span class="remind">*</span><label>发设计更改单</label></th> -->
					<!-- 						<td> -->
					...
					<!-- 							</td> -->
					<!-- 							<th align="right"><span class="remind">*</span><label>发通报</label></th> -->
					<!-- 						<td> -->
					<%-- 							<pt6:syslookup name="attribute02" --%>
					<%-- 							lookupCode="PLATFORM_YES_NO_FLAG" --%>
					<%-- 							isNull = "true" --%>
					<%-- 							dataOptions="required:true,width:180,editable:false,panelHeight:'auto',disabled:'disabled'"> --%>
					<%-- 						</pt6:syslookup> --%>
					...
					<!-- 					</tr> -->
					<tr>
						<th align="right"><label>多个部门并行处理</label></th>
						<td><pt6:syslookup name="attribute03"
								lookupCode="PLATFORM_YES_NO_FLAG" isNull="true"
								dataOptions="required:true,width:180,editable:false,panelHeight:'auto',disabled:'disabled'">
							</pt6:syslookup></td>
						<!-- 							<th align="right"><span class="remind">*</span><label>更改单编号</label></th> -->

						<!-- 						<td><input title="更改单编号" class="easyui-validatebox" -->
						<!-- 							style="width: 180px;" type="text" name="attribute04" id="attribute04" -->
						<!-- 							disabled /> -->

						<!-- 							</td> -->
					</tr>
					<tr>
						<th align="right" id="dealSolution_th"><span class="remind">*</span><label>承办单位处理结论</label></th>
						<td colspan="3" id="dealSolution_td">
							<div style="width: 99%;">
		...
		<iframe id="iframeIdR" width="100%" height="600" frameborder="0"
