...
// 		dealDepartIdDeptCommonSelector.init();
	...
	//	alert("here--->"+attribute03);
		if(attribute03=='Y'){
			...
			//alert("taskNo-->"+taskNo);
			//alert(taskNo);
			var url = "hdkf/support/hdkfsupportsolutiondetail/HdkfSupportSolutionDetailController/HdkfSupportSolutionDetailInfo1?infoCardNo="+infoCardNo;
...
<!-- 					</tr> -->
					...
					<tr>
						<th id="doneTime_th" align="right"><label>方案形成时间</label></th>
					...
					<tr>
						...
						<td id="dealUser_td"><input title="承办单位处理人" class="easyui-validatebox"
...
<!-- 							id="dealUserId" disabled /></td> -->
					...
					<tr>
							<th align="right"><label>发设计更改单</label></th>
						<td>
							...
							<th align="right"><label>发通报</label></th>
						<td>
						...
						<td>
							...
							<th align="right"><label>更改单编号</label></th>
					...
					<tr>
						<th align="right" id="dealSolution_th"><label>承办单位处理结论</label></th>
