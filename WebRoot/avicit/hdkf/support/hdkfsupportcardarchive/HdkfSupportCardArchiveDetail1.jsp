...
// 		//	alert("here124");
// 			//$("#respNo").attr("disabled","disabled");
// 			//$("#respNo").attr("editable",false);
// 			             //attr("disabled",false);
// 		     $('#respNo').css('display', 'none');
// 		     $('#respNo_th').css('display', 'none');
// 		}
//        if($("#respId").val()!=''){
//     	   $("#relateRespDiv").css('display', 'block');
//     	   //$("#attibute02").attr("disabled",true);
// 		}
// //        if($("#attribute03").val()!=''){
...
<%-- 		<c:forEach var="outCardDto" items="${outCardList}" > --%>
<!-- 		<p>1293994949</p> -->
<!-- 		<div style="margin: 10px 5px 20px 10px;" id="outFieldCardDivs"> -->
<%-- 			<span><a id="onOffBtns" onclick="toRequestDetails(${outCardDto.id});" --%>
<!-- 				href="javascript:void(0)">展开外场信息卡详情111</a></span> -->

<!-- 			<iframe id="iframeIds" width="99%" height="870" frameborder="0" -->
<!-- 				style="display: none; margin-top: 10px;"> </iframe> -->
<!-- 		</div> -->
          ...
          <legend>归档信息详情</legend>
			<form id='formDetail'>
				...
				<table class="form_commonTable">
					<tr>
					<th align="right"><label>求援信息编号</label></th>
