...
<!-- ControllerPath = "hdkf/support/hdkfsupportpersondetail/HdkfSupportPersonDetailController/HdkfSupportPersonDetailInfo2" -->
<title></title>
			...
			<thead>
				<tr>
					<th data-options="field:'id', align:'center',checkbox:true"
						width="220">主键</th>
					<th data-options="field:'borrowInfoId', align:'center',hidden:'true'"
...
<!-- 						name="remark" /></td> -->
	...
	<script
		src=" avicit/hdkf/support/hdkfsupportpersondetail/js/HdkfSupportPersonDetail2.js"
		type="text/javascript"></script>
