...
HdkfSupportPersonDetail.prototype.init = function() {
	...
	this._datagrid = $(this._datagridId).datagrid({
		url : timestamp(this._url + 'getHdkfSupportPersonDetailsByPage.json?borrowInfoId=' + borrowInfoId),
...
HdkfSupportPersonDetail.prototype.insert = function() {
	...
	//限制添加人数不超过所需借调人数
	var rows = this._datagrid.datagrid('getRows');
	if(rows.length >= borrowNumber){
		$.messager.alert('提示', '已经达到所需借调人数！', 'warning');
		//return false;
	}
