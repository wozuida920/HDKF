...
<!-- ControllerPath = "hdkf/support/hdkfsupportpersondetail/HdkfSupportPersonDetailController/HdkfSupportPersonDetailInfo1" -->
<title></title>
		...
		<table id="dgHdkfSupportPersonDetail"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'personName', halign:'center'"
						editor="{type:'validatebox',options:{validType:'maxLength[30]'}}"
						width="220">姓名</th>

					<th
						data-options="field:'sex', halign:'center',formatter:formatesex"
						editor="{type:'combobox',options:{panelHeight:'auto',editable:false,valueField:'lookupCode',textField:'lookupName'}}"
						width="220">性别</th>
					<th data-options="field:'cardId', halign:'center'"
						editor="{type:'validatebox',options:{validType:'maxLength[50]'}}"
						width="220">身份证号</th>

					<th data-options="field:'workNum', halign:'center'"
						editor="{type:'validatebox',options:{validType:'maxLength[50]'}}"
						width="220">工号</th>

					<th data-options="field:'majors', halign:'center'"
						editor="{type:'validatebox',options:{validType:'maxLength[50]'}}"
						width="220">专业</th>

					<th data-options="field:'phone', halign:'center'"
						editor="{type:'validatebox',options:{validType:'maxLength[30]'}}"
						width="220">电话</th>
...
<!-- 						name="remark" /></td> -->
	...
	<script
		src=" avicit/hdkf/support/hdkfsupportpersondetail/js/HdkfSupportPersonDetail.js"
		type="text/javascript"></script>
	...
	<script type="text/javascript">
		...
		var borrowNumber = "${borrowPersonInfDTO.borrowNumber}";
		$(function() {
