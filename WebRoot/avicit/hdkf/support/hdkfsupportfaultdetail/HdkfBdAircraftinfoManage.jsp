					  ...
					  <tr>
					       <th width="10%">机型:</th>
							<td width="20%"><input class="easyui-validatebox"
								type="text" name="modelIdAlias" /></td>
							<th width="10%">批架次:</th>
							<td width="20%"><input class="easyui-validatebox"
...
<%-- 							<sec:accesscontrollist hasPermission="3"
				...
				<table id="dgCsmpBdAircraftinfo1"
					data-options="
				fit: true,
				border: false,
				rownumbers: true,
				...
				striped:true">			
					<thead>
						<tr>
							<th data-options="field:'id', halign:'center',hidden:true,checkbox:true"
								width="220">主键ID</th>
							<th
...
<!-- 								width="220">运营商</th> -->
	...
	<script
		src="avicit/hdkf/support/hdkfsupportrequestinfo/js/HdkfBdAircraftinfo.js"
		type="text/javascript"></script>
	<script type="text/javascript">
		...
		$(function(){
			...
			csmpBdAircraftinfo = new CsmpBdAircraftinfo('dgCsmpBdAircraftinfo1', '${url}', 'searchDialog', 'csmpBdAircraftinfo', '${fid}');
			...
			var dgView=$('#dgCsmpBdAircraftinfo1');
