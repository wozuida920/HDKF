...
CsmpBdAircraftinfo.prototype.init = function() {
	...
	if(this.getFid()=="null"){
		...
		url=this.getUrl() + "getCsmpBdAircraftByPage/"+this.getFid();
	}
...
CsmpBdAircraftinfo.prototype.attribute01=[];
Platform6.fn.lookup.getLookupType('CSMP_FM_FAULTHAPPENMONMENT',function(r){r&&( CsmpBdAircraftinfo.prototype.attribute01=r);});
CsmpBdAircraftinfo.prototype.attribute02=[];
Platform6.fn.lookup.getLookupType('PLATFORM_YES_NO_FLAG',function(r){r&&( CsmpBdAircraftinfo.prototype.attribute02=r);});
