...
HdkfSupportFaultDetail.prototype.insert=function(){
	var requestIdR1 = requestIdR+","+requestUnitR;
	this.nData = new CommonDialog("insert","790","500",this.getUrl()+'Add/'+requestIdR1,"添加",false,true,false);
	this.nData.show();
};
//修改页面
HdkfSupportFaultDetail.prototype.modify=function(){
	...
	this.nData = new CommonDialog("edit","790","500",this.getUrl()+'Edit3/'+rows[0].id,"修改",false,true,false);
	this.nData.show();
};
