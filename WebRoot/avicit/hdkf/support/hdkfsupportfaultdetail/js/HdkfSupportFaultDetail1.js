...
HdkfSupportFaultDetail.prototype.init=function(){
	...
	this._datagrid=$(this._datagridId).datagrid({
		url:this.getUrl()+"getHdkfSupportFaultDetailsByPage1.json",
...
HdkfSupportFaultDetail.prototype.insert=function(){
	...
	//批架次处理
	var requestIdR1 = requestIdR+","+requestUnitR+","+batchNosall;//+","+batchNosall;
	//alert(batchNosall);
	this.nData = new CommonDialog("insert","900","800",this.getUrl()+'Add/'+requestIdR1,"添加",false,true,false);
	this.nData.show();
};
//修改页面
HdkfSupportFaultDetail.prototype.modify=function(){
	...
	this.nData = new CommonDialog("edit","900","800",this.getUrl()+'Edit/'+rows[0].id,"修改",false,true,false);
	this.nData.show();
};

//详细页
HdkfSupportFaultDetail.prototype.detail=function(id){
	this.nData = new CommonDialog("edit","900","800",this.getUrl()+'Detail/'+id,"详情",false,true,false);
	this.nData.show();
};
//保存功能
...
HdkfSupportFaultDetail.prototype.reLoad=function(){
	//alert("reload here..."+requestIdR);
	
	this._datagrid.datagrid('load',{requestId:requestIdR});
};
//关闭对话框
