...
<body class="easyui-layout" fit="true">
		...
		<table id="dgHdkfSupportFaultDetail"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'dealSolution', align:'center',formatter:showToolTip" width="420">处理结论</th>
	...
	<script
		src=" avicit/hdkf/support/hdkfsupportfaultdetail/js/HdkfSupportFaultDetail3.js"
		type="text/javascript"></script>
