...
<body class="easyui-layout" fit="true">
			...
			<table class="form_commonTable">
				...
				<tr>
					...
					<td width="40%"><input title="求援日期" class="easyui-datebox"
						...
						editable="false" id="requestDate"
						value='${hdkfSupportFaultDetailDTO.requestDate}'  disabled/></td>
					<th width="10%">发生日期:</th>
					<td width="40%"><input title="发生日期" class="easyui-datebox"
						...
						value='${hdkfSupportFaultDetailDTO.occurrenceDate}' disabled/></td>
					<%-- 				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="5" align="left" style="padding-left: 3px"><textarea
							rows="5" data-options="required:true,validType:'maxLength[2000]'"
							class="textareabox" name="faultDesc" id="faultDesc"
							style="resize: none" disabled></textarea></td>
				</tr>
				<tr>
					<th align="right"><span class="remind">*</span><label>处理结论</label></th>
					<td colspan="5" align="left" style="padding-left: 3px"><textarea
							rows="5" data-options="required:true,validType:'maxLength[2000]'"
	...
	<script type="text/javascript">
		...
		function saveForm() {
			...
			if ($("#dealSolution").val().length > 500) {
				alert("处理结论长度不能超过500");
				return;
			}
