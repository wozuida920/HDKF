...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center'"
		...
		<div id="toolbarHdkfSupportProcessView" class="datagrid-toolbar">
			<table>
				<tr>

					<%-- 					<sec:accesscontrollist hasPermission="3" --%>
					<%-- 						domainObject="formdialog_hdkfSupportProcessView_button_add" --%>
					<%-- 						permissionDes="添加"> --%>
					<!-- 						<td><a class="easyui-linkbutton" iconCls="icon-add" -->
					<!-- 							plain="true" onclick="hdkfSupportProcessView.insert();" -->
					<!-- 							href="javascript:void(0);">添加</a></td> -->
					<%-- 					</sec:accesscontrollist> --%>
					<%-- 					<sec:accesscontrollist hasPermission="3" --%>
					<%-- 						domainObject="formdialog_hdkfSupportProcessView_button_edit" --%>
					<%-- 						permissionDes="编辑"> --%>
					<!-- 						<td><a class="easyui-linkbutton" iconCls="icon-edit" -->
					<!-- 							plain="true" onclick="hdkfSupportProcessView.modify();" -->
					<!-- 							href="javascript:void(0);">编辑</a></td> -->
					<%-- 					</sec:accesscontrollist> --%>
					<%-- 					<sec:accesscontrollist hasPermission="3" --%>
					<%-- 						domainObject="formdialog_hdkfSupportProcessView_button_delete" --%>
					<%-- 						permissionDes="删除"> --%>
					<!-- 						<td><a class="easyui-linkbutton" iconCls="icon-remove" -->
					<!-- 							plain="true" onclick="hdkfSupportProcessView.del();" -->
					<!-- 							href="javascript:void(0);">删除</a></td> -->
					<%-- 					</sec:accesscontrollist> --%>
					<sec:accesscontrollist hasPermission="3"
						domainObject="formdialog_hdkfSupportProcessView_button_query"
						permissionDes="查询">
						<td><a class="easyui-linkbutton" iconCls="icon-search"
							plain="true" onclick="hdkfSupportProcessView.openSearchForm();"
