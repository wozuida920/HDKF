...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center'"
		...
		<div id="toolbarHdkfSupportDeviceDetail" class="datagrid-toolbar" style="display:none">
			<table>
				<tr>
...
<%-- 			<input type="hidden" value="${taskNo}" name="taskNo" id="taskNo"/> --%>
	...
	<script
		src=" avicit/hdkf/support/hdkfsupportdevicedetail/js/HdkfSupportDeviceDetail2.js"
		type="text/javascript"></script>
