...
<!-- ControllerPath = "hdkf/support/hdkfsupportdevicedetail/HdkfSupportDeviceDetailController/HdkfSupportDeviceDetailInfo1" -->
<title></title>
		...
		<table id="dgHdkfSupportDeviceDetail"
			...
			<thead>
				...
				<tr>
					...
					<th data-options="field:'taskNo', halign:'center'"
						editor="{type:'validatebox',options:{validType:'maxLength[30]'}}"
						width="220">任务书编号</th>

					<th data-options="field:'deviceNo', halign:'center'"
						editor="{type:'validatebox',options:{validType:'maxLength[50]'}}"
						width="220">器件编号</th>

					<th data-options="field:'deviceName', halign:'center'"
						editor="{type:'validatebox',options:{validType:'maxLength[50]'}}"
						width="220">器件名称</th>

					<th
						data-options="field:'deviceType', halign:'center',formatter:formatedeviceType"
						editor="{type:'combobox',options:{panelHeight:'auto',editable:false,valueField:'lookupCode',textField:'lookupName'}}"
						width="220">类型</th>
					<th data-options="field:'singleNumber', halign:'center'"
						editor="{type:'validatebox',options:{validType:'maxLength[22]'}}"
						width="220">数量</th>

					<th
						data-options="field:'unit', halign:'center',formatter:formateunit"
						editor="{type:'combobox',options:{panelHeight:'auto',editable:false,valueField:'lookupCode',textField:'lookupName'}}"
						width="220">计量单位</th>
<!-- 					<th data-options="field:'price', halign:'center'" -->
<!-- 						editor="{type:'validatebox',options:{validType:'maxLength[22]'}}" -->
<!-- 						width="220">单价</th> -->

					<th data-options="field:'specifications', halign:'center'"
						editor="{type:'validatebox',options:{validType:'maxLength[80]'}}"
						width="220">规格</th>

					<th data-options="field:'liabilityUnit', halign:'center'"
						editor="{type:'validatebox',options:{validType:'maxLength[100]'}}"
						width="220">责任单位</th>

					<th
						data-options="field:'categorys', halign:'center',formatter:formatecategorys"
						editor="{type:'combobox',options:{panelHeight:'auto',editable:false,valueField:'lookupCode',textField:'lookupName'}}"
						width="220">类别</th>
					<th
						data-options="field:'isRandompart', halign:'center',formatter:formateisRandompart"
						editor="{type:'combobox',options:{panelHeight:'auto',editable:false,valueField:'lookupCode',textField:'lookupName'}}"
						width="120">随机件</th>
					<th
						data-options="field:'validateFlag', halign:'center',formatter:formatevalidateFlag"
						editor="{type:'combobox',options:{panelHeight:'auto',editable:false,valueField:'lookupCode',textField:'lookupName'}}"
						width="120">有效性</th>
					<th
						data-options="field:'serOwned', halign:'center',formatter:formateserOwned"
						editor="{type:'combobox',options:{panelHeight:'auto',editable:false,valueField:'lookupCode',textField:'lookupName'}}"
						width="120">自备</th>
					<th data-options="field:'remark', halign:'center'"
	...
	<div id="searchDialog"
		...
		<form id="hdkfSupportDeviceDetail">
			...
			<tr>
				...
				<tr>
					<th width="10%">类型:</th>
					<td width="40%"><pt6:syslookup name="deviceType"
							lookupCode="CSMP_BD_CLASSIFY_DEPT"
				...
				<tr>
					<th width="10%">计量单位:</th>
					<td width="40%"><pt6:syslookup name="unit"
							lookupCode="CSMP_SPM_UNIT"
							dataOptions="width:151,editable:false,panelHeight:'auto'">
						</pt6:syslookup></td>
					<!-- 通用代码
					<th data-options="field:'validFlag',halign:'center',align:'left', formatter: format" editor="{type:'combobox',options:{required:true,panelHeight:'auto',editable:false,valueField:'lookupCode',textField:'lookupName'}}"  width="220">状态</th>
...
<!-- 						name="price" /></td> -->
				...
				<tr>
					<th width="10%">规格:</th>
					<td width="40%"><input class="easyui-validatebox" type="text"
						name="specifications" /></td>
					<!-- 通用代码
					<th data-options="field:'validFlag',halign:'center',align:'left', formatter: format" editor="{type:'combobox',options:{required:true,panelHeight:'auto',editable:false,valueField:'lookupCode',textField:'lookupName'}}"  width="220">状态</th>
				-->
					<th width="10%">责任单位:</th>
					<td width="40%"><input class="easyui-validatebox" type="text"
						name="liabilityUnit" /></td>
					<!-- 通用代码
					<th data-options="field:'validFlag',halign:'center',align:'left', formatter: format" editor="{type:'combobox',options:{required:true,panelHeight:'auto',editable:false,valueField:'lookupCode',textField:'lookupName'}}"  width="220">状态</th>
				-->
				</tr>
...
<%-- 			<input type="hidden" value="${taskNo}" name="taskNo" id="taskNo"/> --%>
		</form>
	...
	<script
		src=" avicit/hdkf/support/hdkfsupportdevicedetail/js/HdkfSupportDeviceDetail1.js"
		type="text/javascript"></script>
