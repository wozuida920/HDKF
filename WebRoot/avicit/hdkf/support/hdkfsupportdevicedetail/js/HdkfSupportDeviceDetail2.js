...
HdkfSupportDeviceDetail.prototype.init=function(){
	...
	this._datagrid=$(this._datagridId).datagrid({
		url:this._url +'getHdkfSupportDeviceDetailsByPage1.json',
...
//	
//	alert("23");
//	var ed = temp.datagrid('getEditor',{index:index,field: 'deviceNo' });
//	alert("3");
	
    $(selectDeviceNo).val(data.drawingNo);
    
    $(selectDeviceName).val(data.productName);
    $(selectType).val(data.productType);

    $(selectUnit).val(data.unit);
