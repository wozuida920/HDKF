...
HdkfSupportDeviceDetail.prototype.init=function(){
	...
	this._datagrid=$(this._datagridId).datagrid({
		url:timestamp(this._url +'getHdkfSupportDeviceDetailsByPage.json'),
		//url:this._url +'getHdkfSupportDeviceDetailsByPage.json',
...
//                };
            ...
            //    selectSerOwned = serOwnedCell.target;
                ...
                $(taskNoCell.target).focus(function()
                {
                	 //alert('获得了焦点');
                	 openDialogTripTask();
                		});
	...
	if(flag){
		...
		//_self._datagrid.datagrid('reload', {});// 刷新当前页
		 _self._datagrid.datagrid({  
			    url:timestamp(_self._url+'getHdkfSupportDeviceDetailsByPage.json')
			});  
		// alert("1");
...
HdkfSupportDeviceDetail.prototype.searchData =function(){
	...
	var o = JSON.stringify(serializeObject(this.searchForm));
	//alert(o);
...
Platform6.fn.lookup.getLookupType('CSMP_BD_CLASSIFY_DEPT',
		function(r){r&&( HdkfSupportDeviceDetail.prototype.deviceType=r);});  
