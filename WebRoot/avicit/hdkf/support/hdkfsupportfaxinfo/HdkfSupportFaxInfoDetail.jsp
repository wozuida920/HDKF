...
// 			return false;
// 		}
// 		var contentLen= $("#faxContent").val();
// 		if(contentLen.length>250){
// 			alert("传真内容不能大于250字！");
// 			return false;
// 		}
...
// 		}
	...
	function downloadPdf(){	   
	    var pdfId = formId;
		var pdfUrl = "/HDKF/platform/hdkf/support/hdkfsupportfaxinfo/HdkfSupportFaxInfoController/operation/downloadPdf?id="+pdfId;
		window.open(pdfUrl);
	}
				...
				<table class="form_commonTable">
					<tr>
						...
						<td><input title="请求处理ID" class="easyui-validatebox"
							...
							id="requestDealId" /><input title="处理单名称" class="easyui-validatebox"
						...
						<td><input title="求援请求ID" class="easyui-validatebox"
							...
							disabled /><input title="信息处理卡编号" class="easyui-validatebox"
							data-options="required:true,validType:'maxLength[50]'"
					...
					<tr>
						<th align="right"><label>我方电话（86-0791）</label></th>
						<td><input title="请输入我方电话，格式为：XXXXXXXX" class="easyui-validatebox"
							data-options="required:true,validType:'maxLength[50]'"
							missingMessage="请输入我方电话，格式为：XXXXXXXX"
							style="width: 180px;" type="text" name="fromTel" id="fromTel"
							disabled /></td>
						<th align="right"><label>我方传真（86-0791）</label></th>
						<td><input title="请输入我方传真，格式为：XXXXXXXX" class="easyui-validatebox"
							data-options="required:true,validType:'maxLength[50]'"
							missingMessage="请输入我方传真，格式为：XXXXXXXX"
					...
					<tr>
						...
						<td><input title="发送日期" class="easyui-datebox" data-options="required:true"
							style="width: 180px;" type="text" name="sendDate" id="sendDate" editable="false"
							disabled /></td>
					</tr>
					<tr>
						<th align="right"><label>传真页数</label></th>
						<td><input title="传真页数" class="easyui-numberbox easyui-validatebox"
						...
						<td colspan="3">
							<div style="width: 99%;">
								<textarea title="传真内容" rows="5"
									data-options="required:true,validType:'maxLength[250]'"
