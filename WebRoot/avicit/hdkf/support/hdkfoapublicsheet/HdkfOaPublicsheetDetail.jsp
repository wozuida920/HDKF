				...
				<table class="form_commonTable">
					<tr>
						...
						<td><input title="公用笺编号" class="easyui-validatebox"
							style="width: 180px;" type="text" name="sheetno" id="sheetno"
					...
					<tr>
						...
						<td><input title="发文日期" class="easyui-datebox"
							style="width: 180px;" type="text" name="sentdate" id="sentdate"
							disabled /></td>
						<th width="10%"><label>分发单位</label></th>
						<td width="40%"><input class="inputbox" style="width: 180px;"
							type="hidden" name="receiveDep" id="receiveDep" />
							<div class="">
					...
					<tr>
						...
						<td><input title="批次" class="easyui-validatebox"
							style="width: 180px;" type="text" name="batchNo" id="batchNo"
							readOnly="readOnly" /></td>
					</tr>
					<tr>
						<th align="right"><label>架次</label></th>
						<td><input title="架次" class="easyui-validatebox"
					...
					<tr>
						...
						<td><input title="校对人" class="easyui-validatebox"
							style="width: 180px;" type="text" name="proofreader"
							id="proofreader" readOnly="readOnly" /></td>
						<th align="right"><label>审核人</label></th>
						<td><input title="审核人" class="easyui-validatebox"
							style="width: 180px;" type="text" name="reviewer" id="reviewer"
							readOnly="readOnly" /></td>
					</tr>

					<tr>
						<th align="right"><label>审定人</label></th>
						<td><input title="审定人" class="easyui-validatebox"
							style="width: 180px;" type="text" name="approver" id="approver"
							readOnly="readOnly" /></td>
						<!-- 					    <th align="right"><label>备注</label></th>
						<td>
						<input title="备注" class="easyui-validatebox" 
						style="width: 180px;" type="text" name="remarks" id="remarks" disabled/>
						</td> -->
						<th align="right"><label>信息处理卡编号</label></th>
						<td><input title="信息处理卡编号" class="easyui-validatebox"
							style="width: 180px;" type="text" name="attribute02"
							id="attribute02" readOnly="readOnly" /></td>
					</tr>
					<tr>
					...
					<tr>
						<th align="right"><label>公用笺原因</label></th>
