		...
		$.ajax({
			...
			success : function(result) {
				if (result.flag == "success") {
					...
					$("#proofreader").val("${CURRENT_LOGINUSER.name}");
...
<form id='formDetail'>
		...
		<tr>
						...
						<td width="40%"><input title="{param.field.comment}"
							...
							<div class="">
								<input class="easyui-validatebox" name="receiveDepAlias"
									id="receiveDepAlias" readOnly="readOnly" style="width: 179px;"></input>
							</div></td>					  
																</tr>
						<tr>
						...
						<td>
						<input title="批次" class="easyui-numberbox easyui-validatebox" style="width: 180px;" type="text" name="batchNo" id="batchNo" disabled/>
						</td>
																</tr>
						<tr>
																																<th align="right"><label>架次</label></th>
						<td>
						<input title="架次" class="easyui-numberbox easyui-validatebox" style="width: 180px;" type="text" name="sortieNo" id="sortieNo" disabled/>
						</td><!-- 
						...
						<td>
						<input title="校对人" class="easyui-validatebox" style="width: 180px;" type="text" name="proofreader" id="proofreader" readOnly="readOnly"/>
						</td><!-- 
...
<!-- 						<th align="right"><label>备注</label></th>
						<td>
						<input title="备注" class="easyui-validatebox" style="width: 180px;" type="text" name="remarks" id="remarks" disabled/>
						</td> -->
