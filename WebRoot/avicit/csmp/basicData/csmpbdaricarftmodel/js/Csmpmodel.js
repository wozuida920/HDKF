 ...
 * 
 */
function CsmpBdAricarftmodel(datagrid, url, searchD, form) {
...
CsmpBdAricarftmodel.prototype.init = function() {
	...
	this._datagrid = $(this._datagridId).datagrid({
		url : this.getUrl() + "getCsmpmodelsByPage.json"
	});
};
// 添加页面
...
// 打开查询框
CsmpBdAricarftmodel.prototype.openSearchForm = function() {
