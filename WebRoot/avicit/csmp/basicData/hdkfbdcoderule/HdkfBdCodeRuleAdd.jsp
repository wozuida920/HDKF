...
<!-- ControllerPath = "csmp/basicData/hdkfbdcoderule/HdkfBdCodeRuleController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
			...
			<table class="form_commonTable">
				...
				<tr>
					...
					<td width="40%"><input title="机型代码"
						...
						type="text" name="planeCode" id="planeCode" /></td>
					...
					<td width="40%"><input title="当前年份"
						...
						type="text" name="curYear" id="curYear" /></td>
				</tr>
				<tr>
					...
					<td width="40%"><input title="当前最大编码"
						...
						type="text" name="maxNo" id="maxNo" /></td>
					...
					<td width="40%"><input title="序列号位数"
						class="easyui-numberbox easyui-validatebox"
						data-options="required:true,validType:'maxLength[22]',min:3" style="width: 180px;"
						type="text" name="serialnoCount" id="serialnoCount" /></td>
				</tr>
	...
	<script type="text/javascript">
		...
		function closeForm() {
			parent.hdkfBdCodeRule.closeDialog("#insert");
		}
		function saveForm() {
			if ($('#form').form('validate') == false) {
				return;
			}
			parent.hdkfBdCodeRule.save(serializeObject($('#form')), "#insert");
		}
