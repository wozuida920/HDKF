...
// 修改页面
CsmpBdAircraftinfo.prototype.modify = function(obj) {
	...
	this.nData = new CommonDialog("edit", "790", "500", this.getUrl() + 'Edit/'
			+ rows[0].id + '/' + rows[0].modelId + '/'+obj.modelNum, "修改", false, true,
			false);
	this.nData.show();
};
...
Platform6.fn.lookup.getLookupType('CSMP_OM_AIRCRATF_STATUS', function(r) {
