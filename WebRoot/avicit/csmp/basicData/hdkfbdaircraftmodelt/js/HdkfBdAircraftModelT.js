 ...
 * 
 */
function HdkfBdAircraftModelT(tree,url,searchId){
...
//初始化操作
HdkfBdAircraftModelT.prototype.init=function(){
	var _self = this;
...
//选择根节点
HdkfBdAircraftModelT.prototype.selectRootNode=function(self){
...
HdkfBdAircraftModelT.prototype.loadNodeById=function(_self,node){
};
//添加平级菜单
HdkfBdAircraftModelT.prototype.insert=function(){
	if(this._selectNode._parentId=== '-1'){
		alert('不能添加与'+this._selectNode.text+'平级的节点');
		return;
	}
	this._iDg = new CommonDialog("insert","700","400",this.getUrl()+'/operation/Add/'+this._selectNode._parentId,"添加平级节点",false,true,false);
	this._iDg.show();
};
//添加子菜单
HdkfBdAircraftModelT.prototype.insertsub=function(){
	this._iDg=new CommonDialog("insert","700","400",this.getUrl()+'/operation/Add/'+this._selectNode.id,"添加子节点",false,true,false);
	this._iDg.show();
};

//添加子菜单
HdkfBdAircraftModelT.prototype.modify=function(){
	this._eDg=new CommonDialog("modify","700","400",this.getUrl()+'/operation/Edit/'+this._selectNode.id,"编辑",false,true,false);
	this._eDg.show();
};

HdkfBdAircraftModelT.prototype.save=function(form,url,dialog,id){
	var _self = this;
	$.ajax({
		 url:url,
...
HdkfBdAircraftModelT.prototype.del=function(){
...
//关闭对话框
HdkfBdAircraftModelT.prototype.closeDialog=function(id){
	$(id).dialog('close');
};
