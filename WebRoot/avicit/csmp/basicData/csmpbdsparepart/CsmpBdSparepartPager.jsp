...
<body class="easyui-layout" fit="true">
	<div data-options="region:'north'" style="background: #ffffff; height: 113px; padding: 0px; overflow: hidden;">
...
<!-- 					<th data-option="field:">类别</th> -->
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$('#dgCsmpBdSparepart').datagrid({
				onDblClickRow: function(rowIndex, rowData){
					parent.callBack(rowData);
					$("#modelNumber1").dialog('close');
				}
			});
			// 			var array = [];
		...
		//保存方法
		function seleOne(){
			var rows = $("#dgCsmpBdSparepart").datagrid('getChecked');
			if(rows.length !== 1){
