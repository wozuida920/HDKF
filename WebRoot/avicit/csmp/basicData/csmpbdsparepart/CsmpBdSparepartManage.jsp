...
<body class="easyui-layout" fit="true">
				...
				<tr>
					...
					<sec:accesscontrollist hasPermission="3"
						...
						<td><a class="easyui-linkbutton" iconCls="icon-add"
							plain="true" onclick="csmpBdSparepart.insert();"
							href="javascript:void(0);">添加</a></td>
					</sec:accesscontrollist>
					<sec:accesscontrollist hasPermission="3"
						domainObject="formdialog_csmpBdSparepart_button_edit"
						permissionDes="编辑">
						<td><a class="easyui-linkbutton" iconCls="icon-edit"
							plain="true" onclick="csmpBdSparepart.modify();"
							href="javascript:void(0);">编辑</a></td>
					</sec:accesscontrollist>
					<sec:accesscontrollist hasPermission="3"
						domainObject="formdialog_csmpBdSparepart_button_delete"
						permissionDes="删除">
						<td><a class="easyui-linkbutton" iconCls="icon-remove"
							plain="true" onclick="csmpBdSparepart.del();"
							href="javascript:void(0);">删除</a></td>
					</sec:accesscontrollist>
				
					<sec:accesscontrollist hasPermission="3"
						domainObject="formdialog_csmpBdSparepart_button_impor"
						permissionDes="导入">
						<td><a class="easyui-linkbutton" iconCls="icon-import"
							plain="true" onclick="importDataToExcel();"
			...
			<thead>
				<tr>
					<th data-options="field:'id', halign:'center',checkbox:true"
						width="220">主键ID</th>
					<th
						data-options="field:'productName',align:'center', halign:'center',formatter:formateHref"
						width="220">产品名称</th>
					<th
					...
					<th
						...
						width="220">责任单位</th>
					<th
						data-options="field:'validFlag',align:'center', halign:'center',formatter:formateString"
						
						width="220">有效性</th>
					<th data-options="field:'category',align:'center', halign:'center'" 
						width="220">类别</th>
					<th
						data-options="field:'isRandompart',align:'center', halign:'center',formatter:formateString"
						width="220">是否随机件</th>
					<th
	...
	<script
		src="avicit/csmp/basicData/csmpbdsparepart/js/CsmpBdSparepart.js"
		type="text/javascript"></script>
