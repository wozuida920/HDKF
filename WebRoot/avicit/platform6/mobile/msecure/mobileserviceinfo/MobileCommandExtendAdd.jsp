...
<!-- ControllerPath = "platform6/msecure/mobileserviceinfo/MobileServiceInfoController/operation/subs2/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			<input type="hidden" name="id" /> <input type="hidden"
				name="commandId" id="commandId" value='${pid}' />
			<table class="form_commonTable">
				<tr>
					...
					<td width="40%"><input title="方法名称"
						class="easyui-validatebox"
						data-options="required:true,validType:'maxLength[255]'"
						style="width: 180px;" type="text" name="methodName"
						id="headerValue" /></td>
				</tr>
				<tr>
				</tr>
	...
	<script type="text/javascript">
		...
		function closeForm() {
			parent.mobileCommandExtend.closeDialog("#insert");
		}
		function saveForm() {
