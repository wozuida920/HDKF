...
{
	$("#dgUser").datagrid("options").url ="platform/cc/sysposition/getUserListByPage/${positionId}";
	//$('#dgUser').datagrid("reload", {filter_LIKE_u_name: name, filter_LIKE_u_loginName:loginName, filter_LIKE_u_no:no, filter_LIKE_u_status: validFlag} );
