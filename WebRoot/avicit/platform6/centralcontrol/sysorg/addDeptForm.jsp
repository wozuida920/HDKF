...
<%
	...
	Collection<SysLookupSimpleVo> lookUpdeptType = upLoader
			.getLookUpListByType("PLATFORM_DEPT_TYPE",SessionHelper.getApplicationId(),s);//修改平台，转换为通用代码，部门类型
	Collection<SysLookupSimpleVo> lookUpValidFlag = upLoader
			.getLookUpListByType("PLATFORM_VALID_FLAG",SessionHelper.getApplicationId(),s);//修改平台，转换为通用代码，是否有效
%>
<html>
<head>
