...
function initForSearch(){
 $('#searchWord').searchbox({
        ...
        searcher: function (value) {
        	...
        	if(value==null||value==""){
        		path="platform/cc/sysdept/getChildOrgDeptById";
        	}
        	$.ajax({
                cache:false,
                type: "POST",
...
{
	var usd = new CommonDialog("formEditDialog","900","500",path+"avicit/platform6/centralcontrol/sysorg/editDeptForm.jsp?id="+id,"编辑部门");
	var buttons = [{
		text:'提交',
		id : 'formSubimt',
		handler:function(){
...
function showAddDept()
{
	...
	var usd = new CommonDialog("formAddDialog","900","500",path+"avicit/platform6/centralcontrol/sysorg/addDeptForm.jsp","添加部门");
	var buttons = [{
		text:'提交',
		id : 'formSubimt',
		handler:function(){
...
function showAddOrg(){
	...
	var usd = new CommonDialog("formAddDialog","900","500",path+"avicit/platform6/centralcontrol/sysorg/addOrgForm.jsp","添加组织");
	var buttons = [{
		text:'提交',
		id : 'formSubimt',
		//iconCls : 'icon-submit',
...
{
	var usd = new CommonDialog("formEditDialog","900","400",path+"avicit/platform6/centralcontrol/sysorg/editOrgForm.jsp?id="+id,"编辑组织");
	var buttons = [{
		text:'提交',
		id : 'formSubimt',
		//iconCls : 'icon-submit',
	...
	if (rows.length == 1) {
		$.messager.confirm('请确认','您确定执行该操作？',function(b){
			if(b){
				var rowData = rows[0];
			   $.ajax({
				 url:'platform/cc/sysorg/setValidFlag',
