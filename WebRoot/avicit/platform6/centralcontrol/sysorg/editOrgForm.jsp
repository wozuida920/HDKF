...
function loadOrgInfo(orgId){
	$.ajax({
        cache:false,
        type: "POST",
        url:'platform/cc/sysorg/getSysOrgById.json?id='+orgId,
        dataType:"json",
        data:{id:orgId},
...
function mySelectDept(){
	...
	var deptSelector = new CommonDialog("deptSelectDialog","350", "300", path+"/avicit/platform6/centralcontrol/sysdept/selectDept2.jsp?id="+orgId+"&type=org","选择部门", null,null,false);
	deptSelector.show();
}
