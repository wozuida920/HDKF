...
function SysLookupType(datagrid,url,searchD,form){
    ...
    this.getUrl = function(){
    	return _url+SysLookupType.prototype.APPID;
    }
 ...
 * 按照应用id加载
 */
SysLookupType.prototype.loadByAppId=function(appId){
	SysLookupType.prototype.APPID=appId;
	this.init();
	this.loadByAppId = function(p){
    	...
    	SysLookupType.prototype.APPID = p;
		this._datagrid.datagrid({url:this.getUrl()+"/allSysLookupType.json"});
	}
