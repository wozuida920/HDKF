...
jQuery(function(){
	...
	//选择部门
	var deptCommonSelector = new CommonSelector("dept", "deptSelectCommonDialog", "search_DEPT_ID", "DEPT_NAME",'','',null,1,'','部门',600,250);
...
function closeDialog(){
	parent.$("#queryUserDialog").dialog('destroy');
}
</script>
</head>
	...
	<table class="form_commonTable">
		<tr>
			...
			<td>
				...
				<div class=""></div><input class="easyui-validatebox" readonly="readonly" type="text"  name="DEPT_NAME"
					id="DEPT_NAME" ></input></div>
			</td>
		</tr>
		<tr>
			<th>用户姓名：</th>
			...
			<select class="easyui-combobox"
				data-options="{required:true,panelHeight:'auto',editable:false,onShowPanel:comboboxOnShowPanel}" name="search_POSITION_ID" id="search_POSITION_ID" style="width: 155px">
		...
		<tr>
			...
			<td>
					<select class="easyui-combobox"
				data-options="{required:true,panelHeight:'auto',editable:false,onShowPanel:comboboxOnShowPanel}"name="search_USER_LEVEL" id="search_USER_LEVEL" style="width: 155px">
							<option value=""></option>
