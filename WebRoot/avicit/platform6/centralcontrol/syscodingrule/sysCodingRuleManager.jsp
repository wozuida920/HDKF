...
function toComSegment(){
	var usd = new CommonDialog("comSegmentDialog", 700, 400,"avicit/platform6/centralcontrol/syscodingcomsegment/sysCodingComSegmentManager.jsp?appId=" + $appId,"通用码段管理",true,true,false);
	usd.show();
}
			...
			<form id="formSearch">
				<table class="form_commonTable">
					...
					<tr>
						...
						<th width="50px;">状态</th>
						<td width="35%">
							<input class="easyui-combobox" id="searchStatus" name="searchStatus" data-options="editable:false,panelHeight:'auto',valueField:'code',textField:'name',url:'platform/cc/sysCodingRule/getSegmentStatus.json',onShowPanel:comboboxOnShowPanel" value=""/>
						</td>
					</tr>
				</table>
			</form>	
