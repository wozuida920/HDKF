	...
	<div data-options="region:'center',split:true,border:false" style="padding:0px;overflow:hidden;height:0; overflow:hidden;">
		...
		<table id="deptleader" class="easyui-datagrid" 
			data-options=" 
				...
				selectOnCheck: false,
				striped:true,
				url:'platform/cc/crossdept/getData',
...
function insert(){
	$("#deptleader").datagrid('insertRow',{
		index: 0,
		row:{id:"",userName:'<font color=\"#999999\">请选择用户',deptName:'<font color=\"#999999\">请选择部门'}
	}); 
}
//保存
save=function(){
	...
	$.ajax({
		 url:'platform/cc/crossdept/leaddept/save',
	...
	var l =rows.length;
	  ...
	  $.messager.confirm('请确认','您确定要删除当前所选的数据？',function(b){
		 if(b){
			 ...
			 $.ajax({
				 url:'platform/cc/crossdept/leaddept/delete',
