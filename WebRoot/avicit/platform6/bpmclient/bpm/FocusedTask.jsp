...
function doTodo(){
	...
	function cancelFocusedTask(id) {
		if (confirm("是否取消关注?")) {
			ajaxRequest("POST", "dbid=" + id,
					"platform/bpm/clientbpmoperateaction/cancelFocusedTask",
					"json", "backFinished");
		}
	}
	...
	$(function() {
		doTodo();
		if (isIE6) {
			$('#todo_data').datagrid('options').url = 'platform/bpm/clientbpmdisplayaction/getFocusedTask.json?userId='
					+ userId;
			//$('#todo_data').datagrid('resize', {
				//width : 600,
				//height : 300
			//});
...
<body class="easyui-layout" fit="true">
	<div region="center" style="padding:0px;" fit="true" border="false">
