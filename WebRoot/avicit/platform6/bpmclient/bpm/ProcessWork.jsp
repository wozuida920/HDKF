...
function loadTodo(queryParams){
	var dataGridHeight = $(".easyui-layout").height() - $("#Todo_toolbar").height() - 40;
	$('#Todo_data').datagrid({   
	    //height: 'auto',
...
function loadTodoForQuery(queryParams){
...
function loadFinishedTodo(queryParams){
	var dataGridHeight = $(".easyui-layout").height() - $("#FinishedTodo_toolbar").height() - 40;
...
function loadFinishedTodoForQuery(queryParams){
...
function searchFinishedTodoFun(){
	...
	loadFinishedTodoForQuery(queryParams); 
}
...
function bpm_operator_refresh() {
	$('#Todo_data').datagrid('reload'); 
	$('#Todo_data').datagrid('uncheckAll').datagrid('unselectAll').datagrid('clearSelections');
	$('#FinishedTodo_data').datagrid('reload'); 
	$('#FinishedTodo_data').datagrid('uncheckAll').datagrid('unselectAll').datagrid('clearSelections');
}
			...
			<div id="Todo_toolbar" class="datagrid-toolbar" style="height: auto;">
				<fieldset>
					...
					<table class="tableForm" id="Todo_searchForm">
						<tr>
							<td>流程名称</td>
							<td colspan="2"><input id="Todo_processDefName" name="Todo_processDefName"  class="easyui-validatebox" style="width: 150px;" /></td>
							<td style="width:50px"></td>
							
							<td>标题</td>
							<td colspan="2"><input id="Todo_taskTitle" name="Todo_taskTitle"  class="easyui-validatebox" style="width: 150px;" /></td>
							<td style="width:50px"></td>
			...
			<div id="FinishedTodo_toolbar" class="datagrid-toolbar" style="height: auto;">
				<fieldset>
					...
					<table class="tableForm" id="FinishedTodo_searchForm">
						<tr>
							<td>流程名称</td>
							<td colspan="2"><input id="FinishedTodo_processDefName" name="FinishedTodo_processDefName"  class="easyui-validatebox" style="width: 150px;" /></td>
							<td style="width:50px"></td>
							
							<td>标题</td>
							<td colspan="2"><input id="FinishedTodo_taskTitle" name="FinishedTodo_taskTitle"  class="easyui-validatebox" style="width: 150px;" /></td>
							<td style="width:50px"></td>
