...
<div data-options="region:'east',split:true,border:false" style="width:550px;background:#f5fafe;">
		<table id="dgsub"  class="easyui-datagrid"   fit="true" toolbar="#toolbarsub" pagination="false" rownumbers="true" fitColumns="true"  singleSelect="true" checkOnSelect="true" selectOnCheck="false"  autoRowHeight="false" striped="true"   data-options="onLoadSuccess:cellTipsub">
					<thead>
						<tr>
							<th data-options="field:'ID', halign:'center',checkbox:true" width="50">id</th>
