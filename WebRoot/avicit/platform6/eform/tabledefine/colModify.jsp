...
$(function(){
	...
	$('#colRuleName').combobox({
		onSelect: function(record){
			if (record.value == "user" || record.value == "dept"|| record.value == "custom"){
	...
	*/
	...
	/*
	var colRuleName = results.colRuleName;
	if (colRuleName === "user" || colRuleName === "dept" || record.value === "custom" ){
		$("#elementType").combobox("select", "text");
		$("#elementType").combobox('disable');
		$("#colType").combobox("select", "VARCHAR2");
		$("#colType").combobox('disable');
	}else{
		$("#elementType").combobox('enable');
		$("#colType").combobox('enable');
