...
<div data-options="region:'center',split:true,border:false" style="padding:0px;overflow:hidden;">
	<table id="dg"  class="easyui-datagrid"  url="platform/search/connection/list.json"  fit="true" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" striped="true">
		<thead>
			<tr>
	...
	<tr>
		...
		<td><input id="q_connectionName" name="q_connectionName" class="easyui-validatebox"  value="请输入数据库名称..."  onfocus="{this.value='';this.style.color='#000'}"   style="color:#808080"></td>
	...
	<div id="dlg" class="easyui-dialog" style="width: 400px; height: 280px; padding: 10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post" novalidate>
				<div class="fitem"><label>数据库名称:</label> <input name="connectionName" class="easyui-validatebox" required="true"></div>
			    <div class="fitem"><label>数据库地址:</label> <input name="connectionUrl" class="easyui-validatebox" required="true"></div>
				<div class="fitem"><label>数据库用户:</label> <input name="connectionUsername" class="easyui-validatebox" required="true"></div>
				<div class="fitem"><label>数据库密码:</label> <input name="connectionPassword" class="easyui-validatebox" required="true"></div>
				<div class="fitem"><label>数据库驱动:</label> <input name="connectionDriver" class="easyui-validatebox" required="true"></div>
		</form>
	</div>
	<div id="dlg-buttons">
