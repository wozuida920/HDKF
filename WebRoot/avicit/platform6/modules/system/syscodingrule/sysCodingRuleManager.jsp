 ...
 */
function addRule(){
	var usd = new CommonDialog("addCodingRuleDialog","800","385","avicit/platform6/modules/system/syscodingrule/sysCodingRuleAdd.jsp","添加代码规则",true);
	var buttons = [{
		text:'保存',
		id : 'formSubimt',
		iconCls : '',
...
function updateRule(){
	...
	var usd = new CommonDialog("updateCodingRuleDialog","800","385","platform/sysCodingRuleController/toUpdateRuleJsp.jsp?id="+id,"编辑代码规则",true);
	var buttons = [{
		text:'保存',
		id : 'formSubimt',
		iconCls : '',
...
function copyRule(){
	...
	var usd = new CommonDialog("copyCodingRuleDialog","800","385","platform/sysCodingRuleController/toUpdateRuleJsp.jsp?id="+ id +"&isCopy=true","复制代码规则",true);
	var buttons = [{
		text:'保存',
		id : 'formSubimt',
		iconCls : '',
	...
	<form id="formSearch">
		<table class="form_commonTable">
			...
			<tr>
				...
				<th width="50px;">状态</th>
				<td width="35%">
					<input class="easyui-combobox" id="searchStatus" name="searchStatus" data-options="editable:false,panelHeight:'auto',valueField:'code',textField:'name',url:'platform/sysCodingRuleController/getSegmentStatus.json',onShowPanel:comboboxOnShowPanel" value=""/>
				</td>
			</tr>
		</table>
	</form>
