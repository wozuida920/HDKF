...
function initComboData(){
	...
	Platform6.fn.lookup.getLookupType('PLATFORM_GROUP_TYPE',function(r){
		if(r){
			groupTypeComboData=r;
		}
	});
	Platform6.fn.lookup.getLookupType('PLATFORM_USER_TYPE',function(r){
		if(r){
			userTypeComboData=r;
		}
	});
...
function selectUserDialogCallBack(data){
	...
	$.ajax({
        cache:false,
        type: "POST",
        url:'platform/sysgroup/saveUserGroupByIDs.json',
        dataType:"json",
...
<body class="easyui-layout" fit="true">
		<div data-options="region:'north',split:true,title:''" style="height: 300px; padding:0px;">
			<div id="toolbarGroup" class="datagrid-toolbar">
				<sec:accesscontrollist   hasPermission="3" domainObject="pmTaskInfo_tabPower_button_btAddGroup" permissionDes="添加群组">
					<a id="btAddGroup"  class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="showAddGroup();" href="javascript:void(0);">添加</a>
				</sec:accesscontrollist>
				
				<sec:accesscontrollist   hasPermission="3" domainObject="pmTaskInfo_tabPower_button_btSaveGroup" permissionDes="保存群组">
					<a id="btSaveGroup"  class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="saveGroup();" href="javascript:void(0);">保存</a>
				</sec:accesscontrollist>
				
				<sec:accesscontrollist   hasPermission="3" domainObject="pmTaskInfo_tabPower_button_btDeleteGroup" permissionDes="删除群组">
				...
				<sec:accesscontrollist   hasPermission="3" domainObject="pmTaskInfo_tabPower_button_btSearchGroup" permissionDes="查询群组">
			...
			<table id="dgGroup" class="easyui-datagrid"
				...
				<thead>
					<tr>
						...
						<th data-options="field:'applicationName',hidden:true,halign:'center',align:'left'" width="220">应用名称</th>
		...
		<div data-options="region:'center',split:true,title:''" style="padding:0px;">	
			...
			<div id="toolbarUser" class="datagrid-toolbar">
				<sec:accesscontrollist   hasPermission="3" domainObject="pmTaskInfo_tabPower_button_btAddUser" permissionDes="添加用户">
					<a id="btAddUser"  class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="showAddUser();" href="javascript:void(0);">添加用户</a>
				</sec:accesscontrollist>
				
				<sec:accesscontrollist   hasPermission="3" domainObject="pmTaskInfo_tabPower_button_btDeleteUser" permissionDes="删除用户">
				...
				<sec:accesscontrollist   hasPermission="3" domainObject="pmTaskInfo_tabPower_button_btSearchUser" permissionDes="查询用户">
