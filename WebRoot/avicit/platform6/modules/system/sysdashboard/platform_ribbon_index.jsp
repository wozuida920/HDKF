...
<body class="easyui-layout" style="overflow-y:auto;" onload="addTab('系统首页','avicit/platform6/modules/system/sysdashboard/indexPortlet.jsp','static/images/platform/index/images/icons.gif','homePage','-80px -140px');return false;">
