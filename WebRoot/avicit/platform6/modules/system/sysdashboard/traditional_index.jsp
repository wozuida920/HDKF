...
<%
    ...
    String indexElement = sysMenuAPI.getTraditionalIndexElementVlign(SessionHelper.getCurrentUserLanguageCode(request), user, menu,SessionHelper.getApplicationId());
