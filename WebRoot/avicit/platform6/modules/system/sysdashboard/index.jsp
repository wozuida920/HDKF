...
<%
    ...
    String indexElement = sysMenuAPI.getIndexElementVlign(SessionHelper.getCurrentUserLanguageCode(request), user, menu,appId);
...
<script type="text/javascript" src="static/js/platform/component/jQuery/jQuery-1.8.2/jquery.cookie.js"></script>
		...
		<div id="divBodyWidth">
			<div id="header">
				...
				<ul class="info" style="*width:auto;">
					<li id="skinList" style="margin-top: 10px;">
					</li>
					<li>
						<div class="user"></div> 
						<%=loginname%>
					...
					<li>
						...
						<div id="versionDialog" title="平台版本" style="background:#fff;padding:5px;width:400px;height:180px;display:none" ></div>
					</li>
				</ul>
				<%=quickSearch%>
				</div>
