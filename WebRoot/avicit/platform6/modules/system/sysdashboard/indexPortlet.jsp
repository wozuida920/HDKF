...
<%
	...
	if(isgloable==null||isgloable.equals("")){
		...
		isgloable=HtmlUtils.htmlEscape(isgloable);
	}
...
%>
<link type="text/css" rel="stylesheet" href="static/css/platform/themes/<%=skinColor %>/portlet/jquery-ui-1.10.4.custom.css" />
<link type="text/css" rel="stylesheet" href="static/css/platform/themes/<%=skinColor %>/portlet/jquery.portlet.css?v=1.3.1" />
<link type="text/css" rel="stylesheet" href="static/css/platform/themes/<%=skinColor %>/portlet/portlet.css" >
<link type="text/css" rel="stylesheet" href="static/js/platform/component/jQuery/jquery-easyui-1.3.5/themes/<%=skinColor %>/easyui.css" >
<script src="static/js/platform/portal/jquery-1.8.3.min.js" type="text/javascript"></script>
<script src="static/js/platform/portal/jquery-ui-1.10.4.custom.min.js" type="text/javascript"></script>
<script src="static/js/platform/component/jQuery/jquery-easyui-1.3.5/jquery.easyui.min.js" type="text/javascript"></script>
<script src="static/js/platform/portal/jquery.portlet.js" type="text/javascript"></script>
		...
		$('#'+rowId).portlet('option', 'add', {
	        ...
	        portlet: {
	            ...
	            content: {
	                ...
	                type: 'text',
	                text: '<iframe frameborder="0"  src="'+portlet.url+'" width="100%" height="'+portlet.height+'" border="0" frameBorder="0" scrolling="auto" vspace="0" hspace="0" bordercolor="#000000"></iframe>'
	            }
	        }
	    });
		// modify by liub @casue:点击边缘框，内容会缩进
		var width = $('#'+rowId).find(".ui-portlet-column").width();
		//alert("here 1--->9")
		$('#'+rowId).find("iframe").width(width - 9);
	}else{
		$.messager.alert('提示','请先设置页面布局后，再进行portlet添加','info');
	}
}
//添加首页应用，被首页调用
