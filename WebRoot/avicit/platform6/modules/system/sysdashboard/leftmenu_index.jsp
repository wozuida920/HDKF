...
<%
    ...
    String indexElement = sysMenuAPI.getLeftTreeMenus(SessionHelper.getCurrentUserLanguageCode(request), user, menu, appId);
			...
			<div id="header">
				<div class="logo">
					<ul class="info">
						...
						<li>
							<a href="javascript:void(0);" class="nav_icon_user"><%=loginname%></a>
						</li>
						<li>
							<span class="abnt">
