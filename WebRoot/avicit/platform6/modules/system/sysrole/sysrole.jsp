...
function searchRole()
{
	...
	expSearchParams={filter_LIKE_roleName: roleName, filter_LIKE_roleCode: roleCode, filter_EQ_roleType: roleType};
	
	//alert(searchName+","+validFlag);
	
	loadSearchRoleInfo(appid, roleName, roleCode, null, roleType);
};
...
var expSearchParams={};
function importRole(){
	var imp = new CommonDialog("importData","700","400",'platform/excelImportController/excelimport/importRole/xls?extPara='+JSON.stringify({appid:appid}),"Excel数据导入",false,true,false);
	imp.show();
};
...
function exportServerData(){
	$.messager.confirm('确认','是否确认导出Excel文件?',function(r) {
        if (r) {
            ...
            expSearchParams.unContainFields='id,sysDeptId,sysApplicationId,roleType';
...
<body class="easyui-layout" fit="true">
		<div data-options="region:'north',split:true,title:''" style="height:300px; padding:0px;overflow:hidden;">
			...
			<div id="toolbarRole" class="datagrid-toolbar">
				<sec:accesscontrollist   hasPermission="3" domainObject="sysRole_tabPower_button_btAddRole" permissionDes="添加角色">
					<a id="btAddRole"  class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="showAddRole();" href="javascript:void(0);">添加角色</a>
				</sec:accesscontrollist>
				<sec:accesscontrollist   hasPermission="3" domainObject="sysRole_tabPower_button_btSaveRole" permissionDes="保存角色">
					<a id="btSaveRole"  class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="saveRole();" href="javascript:void(0);">保存角色</a>
				</sec:accesscontrollist>
				<sec:accesscontrollist   hasPermission="3" domainObject="sysRole_tabPower_button_btImportRole" permissionDes="导入角色">
				...
				<sec:accesscontrollist   hasPermission="3" domainObject="sysRole_tabPower_button_btExportRole" permissionDes="导出角色">
				...
				<sec:accesscontrollist   hasPermission="3" domainObject="sysRole_tabPower_button_btDeleteRole" permissionDes="删除角色">
					<a id="btDeleteRole" class="easyui-linkbutton" iconCls="icon-remove"  plain="true" onclick="deleteRole();" href="javascript:void(0);">删除角色</a>
				</sec:accesscontrollist>
				<sec:accesscontrollist   hasPermission="3" domainObject="sysRole_tabPower_button_btSearchRole" permissionDes="查询角色">
					<a id="btSearchRole" class="easyui-linkbutton" iconCls="icon-search"  plain="true" onclick="showSearchRole();" href="javascript:void(0);">查询角色</a>
				</sec:accesscontrollist>
			</div>
		...
		<div data-options="region:'center',split:true,title:''" style="padding:0px;height:0; overflow:hidden;">	
			...
			<div id="toolbarUser" class="datagrid-toolbar">
				<sec:accesscontrollist   hasPermission="3" domainObject="sysRole_tabPower_button_btAddUser" permissionDes="添加用户">
					<a id="btAddUser"  class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="showAddUser();" href="javascript:void(0);">添加用户</a>
				</sec:accesscontrollist>
				
				<sec:accesscontrollist   hasPermission="3" domainObject="sysRole_tabPower_button_btDeleteUser" permissionDes="删除用户">
				...
				<sec:accesscontrollist   hasPermission="3" domainObject="sysRole_tabPower_button_btSearchUser" permissionDes="查询用户">
		...
		<div id="searchRoleDialog" class="easyui-dialog" data-options="iconCls:'icon-search',resizable:true,modal:false,buttons:'#searchBtns'" 
			style="width: 600px;height:150px; visible: hidden" title="查询角色">
