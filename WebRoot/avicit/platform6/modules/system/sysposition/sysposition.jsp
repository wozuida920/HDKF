...
function initComboData(){
	...
	Platform6.fn.lookup.getLookupType('PLATFORM_SYS_ROLETYPE',function(r){
		if(r){
			roleTypeComboData=r;
		}
	});
...
<body class="easyui-layout" fit="true">
			...
			<table id="dgPosition" class="easyui-datagrid"
				...
				<thead>
					<tr>
						...
						<th data-options="field:'positionCode', halign:'center',align:'left',required:true" editor="{type:'validatebox',options:{required:true}}" width="220"><span class="red-start">*</span>岗位代码</th>
		...
		<div id="searchPositionDialog" class="easyui-dialog" data-options="iconCls:'icon-search',resizable:true,modal:false,buttons:'#searchBtns'" 
			...
			<form id="searchGroupForm">
	    		<table>
	    			<tr>
	    				<td>岗位代码:</td><td><input type='text' class="easyui-validatebox" name="filter_LIKE_positionCode" id="filter_LIKE_positionCode"/></td>
