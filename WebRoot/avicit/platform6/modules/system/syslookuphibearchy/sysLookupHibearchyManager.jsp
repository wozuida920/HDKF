		   ...
		   <form id="formHibearchy" method="post"> 
				...
				<table class="form_commonTable">
                    ...
                    <tr>
                    	<th>系统级别</th>
                    	<td class="input-readonly">
                        	<input id="systemFlag" name="systemFlag" title="系统级别" class="easyui-combobox" readonly="readonly"
                    ...
                    <tr>
                    	<th>数据编码</th>
                    	<td class="input-readonly">
                        	<input id="typeKey" name="typeKey" title="数据编码" class="easyui-validatebox" type="text" value="" readonly="readonly"/>
                    	</td>
                    </tr>
                    <tr>
                    	<th>系统代码值</th>
                    	<td class="input-readonly">
                        	<input id="typeValue" name="typeValue" title="系统代码值" class="easyui-validatebox" type="text" value="" readonly="readonly"/>
                    	</td>
                    </tr>
                    <tr>
                    	<th>排序</th>
                    	<td class="input-readonly">
                        	<input id="orderBy" name="orderBy" title="排序" class="easyui-numberbox" type="text" data-options="min:0" value="" readonly="readonly"/>  
                    	</td>
                    </tr>
                    <tr>
                    	<th>备注</th>
                    	<td class="input-readonly">
                        	<textarea style="height: 50px;" id="remark" name="remark" class="textareabox input-readonly" title="备注" readonly="readonly"></textarea>
                    	</td>
                	</tr>
                </table>	
			</form>
