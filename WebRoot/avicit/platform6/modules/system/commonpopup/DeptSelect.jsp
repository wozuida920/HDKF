...
if(extParameter){
	var extParameterMap = JSON.parse(extParameter);
	if(extParameterMap.onlyLeafCheck && extParameterMap.onlyLeafCheck == "true"){
		onlyLeafCheck = true;
	}
}
$(function(){
	$('#deptQueryText').searchbox({
        ...
        searcher: function (value) {
            ...
            var param="selectType=dept&deptKeyWord="+encodeURI(value);
	    ...
	    var orgData =   eval(orgDatajson);
		 $('#orgTree_dept').tree({
	 		...
	 		onCheck :function(node, checked){
	 			if(onlyLeafCheck){
	 				var b = $('#orgTree_dept').tree('isLeaf',node.target);
		 			if(!b){
		 				return;
		 			}
	 			}
