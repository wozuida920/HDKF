	 		...
	 		onCheck :function(node, checked){
	 			...
	 			if(nodeType=='user'){
	 				...
	 				$.each(childNodes,function(i,currNode){
	 					...
	 					var currSelectionData = {"userId":currNode.id,"userName":currNodeName_,"deptId":node.id,"deptName":node.text,"userNo":userNo};
	 					if(checked){
 ...
 */
 function query(value){
      ...
      var param="selectType=user&userKeyWord="+encodeURI(value)+"&extParameter="+extParameter;
