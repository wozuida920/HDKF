...
function loadRoleList(){
	...
	var extParameter = '<%=request.getParameter("extParameter")%>';
	...
	$('#roleList').datagrid({
		url:'platform/commonSelection/commonSelectionController/getSysRole?type=role&extParameter='+extParameter,
		idField:'id',
		width: '100%',
	    nowrap: false,
	    striped: true,
