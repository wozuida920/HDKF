...
<head>
    ...
    jQuery(function(){
		 ...
		 //选择部门
		   var deptCommonSelector = new CommonSelector("dept","deptSelectCommonDialog","selectDeptId","selectDeptName",null,null,'{"onlyLeafCheck":"true"}');
		   deptCommonSelector.init(); //选择部门
		 //选择组织
		   var orgCommonSelector = new CommonSelector("org","orgSelectCommonDialog","selectOrgId","selectOrgName",null,null);
		   orgCommonSelector.init(); //选择组织
		   //选择角色
		   var roleCommonSelector = new CommonSelector("role","roleSelectCommonDialog","selectRoleId","selectRoleName",null,null,null);
		   roleCommonSelector.init(); //选择角色
		   //选择群组
		   var groupCommonSelector = new CommonSelector("group","groupSelectCommonDialog","selectGroupId","selectGroupName",null,null,null);
         ...
         <div class="formExtendBase">
       	<fieldset>
			...
			<fieldset>
				...
				<tr>
					<td>组织ID</td>
					<td><input name="selectOrgId" id="selectOrgId"  style="display:block;" readOnly="readOnly"   /></input>
					</td>
					<td>组织名称</td>
					<td><div class="formUnit column"><div class="inputContainer"><input class="easyui-validatebox"  name="selectOrgName"   id="selectOrgName" readOnly="readOnly"  style="width:200px;" ></input></div></div>
					</td>
				</tr>
