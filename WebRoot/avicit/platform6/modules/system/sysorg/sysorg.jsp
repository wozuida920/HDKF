...
{
	var usd = new CommonDialog("formEditDialog","900","500",path+"avicit/platform6/modules/system/sysorg/editDeptForm.jsp?id="+id,"编辑部门");
	var buttons = [{
		text:'提交',
		id : 'formSubimt',
		handler:function(){
...
function showAddDept()
{
	...
	var usd = new CommonDialog("formAddDialog","900","500",path+"avicit/platform6/modules/system/sysorg/addDeptForm.jsp","添加部门");
	var buttons = [{
		text:'提交',
		id : 'formSubimt',
		handler:function(){
...
function showAddOrg()
{
	...
	var usd = new CommonDialog("formAddDialog","900","500",path+"avicit/platform6/modules/system/sysorg/addOrgForm.jsp","添加组织");
	var buttons = [{
		text:'提交',
		id : 'formSubimt',
		handler:function(){
...
function showEditOrg(id){
	var usd = new CommonDialog("formEditDialog","900","400",path+"avicit/platform6/modules/system/sysorg/editOrgForm.jsp?id="+id,"编辑组织");
	var buttons = [{
		text:'提交',
		id : 'formSubimt',
		handler:function(){
