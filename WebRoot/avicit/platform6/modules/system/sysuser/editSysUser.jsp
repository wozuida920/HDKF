				...
				<input type="hidden" name="id" id="id" value='${sysUser.id}' />
					<table  class="form_commonTable">
						...
						<tr>
							...
							<td>
								<input title="登录名" class="easyui-validatebox" type="text" value='<c:out value='${sysUser.loginName}'/>' name="loginName" id="loginName" data-options="required:true" onblur="checkLoginName(this,'${userId}');" onfocus="checkInLoginName(this);"/>
							</td>
						</tr>
						<tr>
					...
					<table class="form_commonTable">
						<tr>
							<th width="15%" ><span class="remind">*</span>岗位名称:</th>
							<td width="35%">
						...
						<tr>
							...
							<td><input type="radio" id="typeC" name="type" value="0"
								checked="true" /><span><label for="typeC">自定义用户:</span> <input
								type="radio" id="typeS" name="type" value="1" /><span><label
									for="typeS">系统用户:</span></td>
						</tr>
						<tr>
						...
						<tr>
							<th >办公电话:</th>
							<td>
								  	<input title="办公电话" class="easyui-numberbox" type="text" name="officeTel" id="officeTel" value='<c:out value='${sysUser.officeTel}'/>'/>
							</td>
							<th>传真:</th>
							<td>
							  	<input title="传真" class="easyui-numberbox" type="text" name="fax" id="fax" value='<c:out value='${sysUser.fax}'/>'/>
							</td>
						</tr>
						<tr>
							<th >邮箱地址:</th>
