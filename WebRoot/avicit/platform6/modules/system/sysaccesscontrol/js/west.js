...
//	var dataGridHeight = $(".easyui-layout").height()-73;
	$('#roleList').datagrid({
		...
		columns:[[
                    {field:'id',title:'角色ID',width:0,hidden:'true',fit:true},
					{field:'roleName',title:'角色名称',width:30,align:'left',fit:true},
					{field:'roleDesc',title:'角色描述',width:30,align:'left',sortable:true,fit:true}
				]],
				toolbar: '#RoleToolbar'
	});
}
