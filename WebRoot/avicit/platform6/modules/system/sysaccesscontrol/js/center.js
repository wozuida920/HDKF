...
function selectOneRow() {
	findComponentResources(window.MENU_ID);
...
function remarkformat(value, rowData, rowIndex) {
	...
	if("1" == value) 
		return "<img src='static/images/platform/sysmenuaccesscontrol/ok.png' title='允许访问' onclick='window.changeSingleMenuAuth(this);' alt=" + rowData.ID +">";
	if("0" == value) 
		return "<img src='static/images/platform/sysmenuaccesscontrol/no.gif' title='禁止访问' onclick='window.changeSingleMenuAuth(this);' alt=" + rowData.ID +">";

	return "<img src='static/images/platform/sysmenuaccesscontrol/untitled.png' title='未设置权限' onclick='window.changeSingleMenuAuth(this);' alt=" + rowData.ID +">";	
}
