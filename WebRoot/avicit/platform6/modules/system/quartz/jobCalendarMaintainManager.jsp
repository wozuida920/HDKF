...
function addCalendar(){
	var usd = new CommonDialog("addCalendarDialog","450","220","avicit/platform6/modules/system/quartz/jobCalendarAdd.jsp","添加日历",true);
	var buttons = [{
		text:'提交',
		id : 'formSubimt',
		iconCls : '',
...
function updateCalendar(){
	...
	var id = selected.id;
	var usd = new CommonDialog("updateCalendarDialog","450","220","avicit/platform6/modules/system/quartz/jobCalendarUpdate.jsp?id=" + id,"修改日历",true);
	var buttons = [{
		text:'提交',
		id : 'formSubimt',
		iconCls : '',
	        ...
	        <div region="center" border="false" style="padding: 5px 15px 0px 0px;">
				<table class="form_commonTable">
					<tr>
						...
						<td><input id="excludedDate" name="excludedDate" class="easyui-datebox" editable="false"/></td>
					</tr>
					<tr>
						<th>描述</th>
						<td><textarea id="description" name="description" class="textareabox" style="height: 50px"></textarea></td>
					</tr>
				</table>
			</div>
