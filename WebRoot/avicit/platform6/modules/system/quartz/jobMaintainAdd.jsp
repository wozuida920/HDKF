		...
		<form id="formJob" fit="true">
			...
			<table class="form_commonTable">
				<tr>
                	...
                	<td>
                    	<input id="name" name="name" title="任务名称" class="easyui-validatebox" type="text" data-options="required:true" />
                	</td>
                </tr>
                <tr>
                	...
                	<td class="input-readonly">
                    	<input id="cron" name="cron" title="表达式" class="easyui-subwindow" type="text" data-options="required:true,onClick:openSelectCron" value="0/5 0/6 * ? * *" />
                	</td>
                </tr>
                <tr>
                	<th>类型说明</th>
                ...
                <tr>
                	...
                	<td colspan="3">
                    	<input id="program" name="program" title="执行程序" class="easyui-validatebox" type="text" data-options="required:true" value="" />
                	</td>
                </tr>
                <tr>
                	<th>描述</th>
                	<td colspan="3">
                    	<input id="description" name="description" title="描述" class="easyui-validatebox" type="text" data-options="required:false" value="" />
                	</td>
                </tr>
            </table>
		</form>
