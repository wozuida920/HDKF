		...
		<form id="formJob" fit="true">
			...
			<table class="form_commonTable">
				<tr>
                	...
                	<td width="40%">
                    	<input id="group" name="group" title="任务分组" class="easyui-combobox" type="text" value="${job.group}"
						    data-options="required:true,editable:false,panelHeight:'auto',valueField:'name',textField:'description',onShowPanel:comboboxOnShowPanel,
						    url:'platform/jobMaintainController/loadGroups.json'" />
                	</td>
                	<th width="10%"><span class="remind">*</span>任务名称</th>
                	<td>
                    	<input id="name" name="name" title="任务名称" class="easyui-validatebox" type="text" data-options="required:true" value="${job.name}" />
                	</td>
                </tr>
                <tr>
                	<th><span class="remind">*</span>任务类型</th>
                	<td>
                    	<input id="type" name="type" title="任务类型" class="easyui-combobox" value="${job.type}"
						    data-options="required:true,editable:false,panelHeight:'auto',onShowPanel:comboboxOnShowPanel,
                	...
                	<td class="input-readonly">
                    	<input id="cron" name="cron" title="表达式" class="easyui-subwindow" type="text" data-options="required:true,onClick:openSelectCron" value="${job.cron}"/>
                	</td>
                </tr>
                <tr>
                	<th>类型说明</th>
                ...
                <tr>
                	...
                	<td colspan="3">
                    	<input id="program" name="program" title="执行程序" class="easyui-validatebox" type="text" data-options="required:true" value="${job.program}" />
                	</td>
                </tr>
                <tr>
                	<th>描述</th>
                	<td colspan="3">
                    	<input id="description" name="description" title="描述" class="easyui-validatebox" type="text" data-options="required:false" value="${job.description}" />
                	</td>
                </tr>
            </table>
		</form>
	...
	<div data-options="region:'south'" split="false" style="height:40px;">
		<div id="toolbar" class="datagrid-toolbar datagrid-toolbar-extend foot-formopera">
			<table class="tableForm" border="0" cellspacing="1" width='100%'>
              	<tr>
                  	<td align="right">
                  		<a title="保存" id="saveButton"  class="easyui-linkbutton primary-btn" plain="false" onclick="updateJob();" href="javascript:void(0);">保存</a>
