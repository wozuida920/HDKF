...
$(function(){
	...
	$.ajax({
		url: 'platform/syslookuptype/getLookUpCode/PLATFORM_MESSAGE_READFLAG.json',
		type :'get',
		dataType :'json',
		success : function(r){
			if(r){
	...
	$('#recvUserName').attr('disabled', true);
   	var commonSelector = new CommonSelector("user","userSelectCommonDialog", "recvUser" ,"recvUserName",null,null,null,false);
