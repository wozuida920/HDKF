	...
	<div data-options="region:'center',split:true,border:false" style="overflow:hidden;padding-bottom:35px;">
				<form id="formssologin" method="post">
					<table width="">
						...
						<tr>
						<tr>
							<th align="right" class="label">SSO登录URL</th>
							<td align="left" width="">
							...
							<th align="right" class="label">SSO退出URL</th>
						...
						<tr height="15px"></tr>
						<tr>
							<th align="right" class="label">当前应用服务器名称</th>
							<td align="" width="">
								<span class="requiedbox" style="width: 468px; height: 23px;">
									<span>
										<span class="required-icon"></span>
							...
							<th align="right" class="label">当前应用登录URL</th>
							<td align="" width="">
							<span class="requiedbox" style="width: 468px; height: 23px;">
										<span>
											<span class="required-icon"></span>
						...
						<tr height="15px"></tr>
						<tr>
							<th align="right" class="label">SSO服务器</th>
							<td align="" width="">
							<span class="requiedbox" style="width: 468px; height: 23px;">
										<span>
											<span class="required-icon"></span>
							...
							<th align="right" class="label">SSO登录启用</th>
