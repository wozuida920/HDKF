 ...
 */
 function toLockLog(){
		...
		var path="platform/sysuser/toUserLockJsp?id="+rows[0].ID;
	...
	<div id="toolbarUser" >
						<table >
							...
							<sec:accesscontrollist hasPermission="3" domainObject="sysuser_toolbar_insertUser" permissionDes="添加">
								...
								<sec:accesscontrollist hasPermission="3" domainObject="sysuser_toolbar_setValidFlag" permissionDes="有效设置">
								...
								<sec:accesscontrollist hasPermission="3" domainObject="sysuser_toolbar_importUser" permissionDes="导入用户">
								<td><a class="easyui-linkbutton" iconCls="icon-import" plain="true" onclick="importUser();" href="javascript:void(0);">导入用户</a></td>
								</sec:accesscontrollist>
								<sec:accesscontrollist hasPermission="3" domainObject="sysuser_toolbar_exportUser" permissionDes="导出用户">
								...
								<sec:accesscontrollist hasPermission="3" domainObject="sysuser_toolbar_transferToDo" permissionDes="移交待办">
								<td><a class="easyui-linkbutton" iconCls="icon-redo" plain="true" onclick="transferToDo();" href="javascript:void(0);">移交待办</a></td>
								</sec:accesscontrollist>
							</tr>
						</table>
					</div>
