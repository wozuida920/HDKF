...
<html>
	...
	<!-- 
		参数说明:
		form_id:业务表ID
		save_type:true表示保存在硬盘，false表示保存在磁盘，other表示其他存储方式，fastfds表示使用FastFDS
	...
	-->
		<jsp:include page="/avicit/platform6/modules/system/swfupload/swfViewInclude.jsp">
			<jsp:param name="form_id" value="8a58ab2a485e5c9d01485e5f29fd0001" />
			...
			<jsp:param name="form_field" value="8a58ab2a485e5c9d01485e5f29fd0003,8a58ab2a485e5c9d01485e5f29fd0002" />
		</jsp:include>
	</body>
</html>