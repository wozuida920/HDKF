...
function addProcessUser(){
	var usd = new UserSelectDialog('userSelectCommonDialog', 700, 400,
			getPath2() + '/platform/user/bpmSelectUserAction/userSelectCommon?isMultiple=true',
			'选择人员部门');
	var buttons = [ {
		text : '确定',
		id : 'processSubimt',
...
function addProcessDept(){
	var usd = new UserSelectDialog('userSelectCommonDialog', 700, 400,
			getPath2() + '/platform/user/bpmSelectUserAction/deptSelectCommon?isMultiple=true',
			'选择部门');
	var buttons = [ {
		text : '确定',
		id : 'processSubimt',
...
function addProcessRole(){
	var usd = new UserSelectDialog('userSelectCommonDialog', 700, 400,
			getPath2() + '/platform/user/bpmSelectUserAction/roleSelectCommon?isMultiple=true',
			'选择角色');
	var buttons = [ {
		text : '确定',
		id : 'processSubimt',
...
function addProcessGroup(){
	var usd = new UserSelectDialog('userSelectCommonDialog', 700, 400,
			getPath2() + '/platform/user/bpmSelectUserAction/groupSelectCommon?isMultiple=true',
			'选择群组');
	var buttons = [ {
		text : '确定',
		id : 'processSubimt',
...
function addProcessPosition(){
	var usd = new UserSelectDialog('userSelectCommonDialog', 700, 400,
			getPath2() + '/platform/user/bpmSelectUserAction/positionSelectCommon?isMultiple=true',
			'选择岗位');
	var buttons = [ {
		text : '确定',
		id : 'processSubimt',
