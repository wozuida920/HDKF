...
$(function(){
	...
	$('#processForm').datagrid({
        ...
        columns:[[
                  ...
                  {field:'formUrl',title:'表单URL',width:200},
                  {field:'formType',title:'表单类型',width:80,rowspan:2},
                  {field:'proxyPage',title:'是否代理',width:80, align: 'center',formatter: typeformatter, editor: { type: 'combobox', options: { data: proxyValue, valueField: "value", textField: "text",editable:false,onSelect:endEdit}}}
              ]]
	});
});
