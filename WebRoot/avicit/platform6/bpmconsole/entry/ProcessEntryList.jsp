		...
		toolbar:[
				{
					...
					handler:function(){
						...
						if(processDefinitionId){
							...
							var url = getPath2()+"/avicit/platform6/bpmconsole/entry/NewProcessEntry.jsp";
...
function expand() {
	...
	function checkBeforeDelete(id,entryId) {
		$.messager.confirm("操作提示", "您确认要删除流程实例吗?", function(data) {
			if (data) {
				easyuiMask();
				ajaxRequest("POST", "processInstanceId=" + id+"&entryId=" + entryId,
	...
	function checkIsSelect(type) {
		...
		if ('delete' == type) {
			checkBeforeDelete(ids,entryIds);
		}
	}
		...
		<div id="toolbar" class="datagrid-toolbar" style="height:auto;display: block;">
			<fieldset>
				...
				<table class="tableForm" id="searchForm" width='100%'>
					<tr>
						<td >流程实例ID：</td>
						<td colspan="2"><input name="entryid" id="entryid" editable="false" style="width: 150px;" class="easyui-validatebox"/>
						<td>流程实例名称：</td>
						<td colspan="2"><input name="entryname" id="entryname"  editable="false" style="width: 150px;" class="easyui-validatebox"/>
						</td>
						<td>流程定义名称：</td>
						<td colspan="2"><input name="definename" id="definename"  editable="false" style="width: 150px;" class="easyui-validatebox"/>
						</td>
						<td>状态：</td>
