...
<head>
	...
	<script type="text/javascript">
		...
		function doQuery(tab){
		    ...
		    ajaxRequest("POST",data,"platform/bpm/bpmconsole/processPositionAnalysisAction/get"+tab,"json","get"+tab+"Back");
		}
		...
		function doQueryAll(tab){
			var startDate =$("#"+tab+"Search input[comboname=startDate]").datetimebox('getValue');
			var endDate =$("#"+tab+"Search input[comboname=endDate]").datetimebox('getValue');
		    var url  = getPath2()+"/avicit/platform6/bpmconsole/analysis/ProcessPositionAnalysisAll.jsp";
			var title = "统计信息";
			...
			top.addTab(title,url,"static/images/platform/index/images/icons.gif","ProcessPositionAnalysisAll"," -0px -120px");
		}
		...
		function openUserAnalysisAll(tab, id) {
			...
			if (tab == 'TodoCompleteTop10') {
				...
				url += "?startDate="+startDate+"&endDate="+endDate+"&querySign=all"+"&tab="+tab+"&title="+title+"&positionId="+id;
	...
	<body>
		<div class="easyui-tabs" id="processPositionAnalysis">
